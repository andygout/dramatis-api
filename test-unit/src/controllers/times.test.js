...
import { Time } from '../../../src/models/index.js';
...
describe('Times controller', () => {
	...
	beforeEach(async () => {
		...
		timesController = await esmock('../../../src/controllers/times.js', {
	...
	const callFunction = async (functionName) => {
		return timesController[functionName](stubs.request, stubs.response, stubs.next);
	};
	...
	describe('newRoute function', () => {
		it('calls sendJsonResponse module', async () => {
			...
			sinonAssert.calledOnceWithExactly(
				...
				stubs.response,
				stubs.models.Time() // eslint-disable-line new-cap
			);
