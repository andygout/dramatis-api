...
import { Locale } from '../../../src/models/index.js';
...
describe('Locales controller', () => {
	...
	beforeEach(async () => {
		...
		localesController = await esmock('../../../src/controllers/locales.js', {
	...
	const callFunction = async (functionName) => {
		return localesController[functionName](stubs.request, stubs.response, stubs.next);
	};
	...
	describe('newRoute function', () => {
		it('calls sendJsonResponse module', async () => {
			...
			sinonAssert.calledOnceWithExactly(
				...
				stubs.response,
				stubs.models.Locale() // eslint-disable-line new-cap
			);
