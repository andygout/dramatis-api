...
describe('Award ceremonies controller', () => {
	...
	describe('newRoute function', () => {
		it('calls sendJsonResponse module', async () => {
			...
			assert.strictEqual(stubs.sendJsonResponse.mock.callCount(), 1);
	...
	describe('createRoute function', () => {
		it('calls callInstanceMethod module', async () => {
			...
			assert.strictEqual(stubs.callClassMethodsModule.callInstanceMethod.mock.callCount(), 1);
	...
	describe('listRoute function', () => {
		it('calls callStaticListMethod module', async () => {
			...
			assert.strictEqual(stubs.callClassMethodsModule.callStaticListMethod.mock.callCount(), 1);
