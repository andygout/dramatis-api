		...
		WITH production,
			COLLECT(
				collectionProduction {
					...
					.name,
					.subtitle,
					startDate: toString(collectionProduction.startDate),
					pressDate: toString(collectionProduction.pressDate),
					endDate: toString(collectionProduction.endDate),
					isSubjectProduction,
					isSurProduction,
					isSurSurProduction,
					isSubProduction,
					...
					surProduction: HEAD([
						surSurProduction IN collectionProductions WHERE surSurProduction.isSurSurProduction |
							surSurProduction {
								...
								.name,
								.subtitle,
								startDate: toString(surSurProduction.startDate),
								pressDate: toString(surSurProduction.pressDate),
								endDate: toString(surSurProduction.endDate),
								.material,
								.venue,
								.season,
								.festival,
					...
					subProductions: [
						subSubProduction IN collectionProductions
							...
							subSubProduction {
								...
								.name,
								.subtitle,
								startDate: toString(subSubProduction.startDate),
								pressDate: toString(subSubProduction.pressDate),
								endDate: toString(subSubProduction.endDate),
								.material,
								.venue,
								.season,
								.festival,
