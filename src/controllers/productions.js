...
const newRoute = (request, response, next) => sendJsonResponse(response, new Production(productionSeedProps));
...
const listRoute = (request, response, next) => callStaticListMethod(response, next, Production, MODELS.PRODUCTION);
