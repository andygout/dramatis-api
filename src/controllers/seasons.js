...
const newRoute = (request, response, next) => sendJsonResponse(response, new Season());
...
const listRoute = (request, response, next) => callStaticListMethod(response, next, Season, MODELS.SEASON);
