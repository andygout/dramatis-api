...
const newRoute = (request, response, next) => sendJsonResponse(response, new Award());
...
const listRoute = (request, response, next) => callStaticListMethod(response, next, Award, MODELS.AWARD);
