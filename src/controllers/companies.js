...
const newRoute = (request, response, next) => sendJsonResponse(response, new Company());
...
const listRoute = (request, response, next) => callStaticListMethod(response, next, Company, MODELS.COMPANY);
