...
const newRoute = (request, response, next) => sendJsonResponse(response, new Person());
...
const listRoute = (request, response, next) => callStaticListMethod(response, next, Person, MODELS.PERSON);
