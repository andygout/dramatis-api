...
const newRoute = (request, response, next) => sendJsonResponse(response, new Venue(venueSeedProps));
...
const listRoute = (request, response, next) => callStaticListMethod(response, next, Venue, MODELS.VENUE);
