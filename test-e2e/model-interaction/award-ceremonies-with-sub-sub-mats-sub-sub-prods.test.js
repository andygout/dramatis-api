...
describe('Award ceremonies with sub-sub-materials and sub-sub-productions', () => {
	...
	const MID_HOGE_MATERIAL_UUID = '11';
	const SUR_HOGE_MATERIAL_UUID = '17';
	const SUB_WIBBLE_MATERIAL_UUID = '22';
	const MID_WIBBLE_MATERIAL_UUID = '27';
	const SUR_WIBBLE_MATERIAL_UUID = '33';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '36';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '38';
	const MID_HOGE_NOËL_COWARD_PRODUCTION_UUID = '39';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '42';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '45';
	const MID_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '48';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '51';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '61';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '62';
	const CONOR_CORGE_PERSON_UUID = '63';
	const STAGECRAFT_LTD_COMPANY_UUID = '64';
	const FERDINAND_FOO_PERSON_UUID = '65';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '75';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '76';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '89';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '90';
