...
describe('Award ceremonies with sub-sub-materials and sub-sub-productions', () => {
	...
	const MID_HOGE_MATERIAL_UUID = '10';
	const SUR_HOGE_MATERIAL_UUID = '15';
	const SUB_WIBBLE_PART_I_MATERIAL_UUID = '18';
	const SUB_WIBBLE_PART_II_MATERIAL_UUID = '20';
	const MID_WIBBLE_SECTION_I_MATERIAL_UUID = '26';
	const MID_WIBBLE_SECTION_II_MATERIAL_UUID = '30';
	const SUR_WIBBLE_MATERIAL_UUID = '36';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '39';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '40';
	const MID_HOGE_NOËL_COWARD_PRODUCTION_UUID = '41';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '43';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '45';
	const SUB_WIBBLE_PART_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '47';
	const MID_WIBBLE_SECTION_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '49';
	const MID_WIBBLE_SECTION_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '51';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '53';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '62';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '63';
	const CONOR_CORGE_PERSON_UUID = '64';
	const STAGECRAFT_LTD_COMPANY_UUID = '65';
	const FERDINAND_FOO_PERSON_UUID = '66';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '76';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '77';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '90';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '91';
	const THE_STAGE_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '100';
	const THE_STAGE_THEATRE_AWARDS_AWARD_UUID = '101';
	const WHATSONSTAGE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '106';
	const WHATSONSTAGE_AWARDS_AWARD_UUID = '107';
