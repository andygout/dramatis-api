...
describe('Award ceremonies with sub-sub-materials and sub-sub-productions', () => {
	...
	const MID_HOGE_MATERIAL_UUID = '12';
	const SUR_HOGE_MATERIAL_UUID = '19';
	const SUB_WIBBLE_MATERIAL_UUID = '24';
	const MID_WIBBLE_MATERIAL_UUID = '30';
	const SUR_WIBBLE_MATERIAL_UUID = '37';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '40';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '42';
	const MID_HOGE_NOËL_COWARD_PRODUCTION_UUID = '43';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '46';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '49';
	const MID_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '52';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '55';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '65';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '66';
	const CONOR_CORGE_PERSON_UUID = '67';
	const STAGECRAFT_LTD_COMPANY_UUID = '68';
	const FERDINAND_FOO_PERSON_UUID = '69';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '79';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '80';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '93';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '94';
