...
describe('Award ceremonies with sub-sub-materials and sub-sub-productions', () => {
	...
	const MID_HOGE_NOËL_COWARD_PRODUCTION_UUID = '59';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '63';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '67';
	const SUB_WIBBLE_PART_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '71';
	const MID_WIBBLE_SECTION_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '75';
	const MID_WIBBLE_SECTION_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '79';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '83';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '94';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '95';
	const CONOR_CORGE_PERSON_UUID = '96';
	const STAGECRAFT_LTD_COMPANY_UUID = '97';
	const FERDINAND_FOO_PERSON_UUID = '98';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '108';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '109';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '122';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '123';
	const THE_STAGE_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '132';
	const THE_STAGE_THEATRE_AWARDS_AWARD_UUID = '133';
	const WHATSONSTAGE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '138';
	const WHATSONSTAGE_AWARDS_AWARD_UUID = '139';
