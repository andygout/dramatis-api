...
describe('Award ceremonies with crediting sub-sub-materials', () => {
	...
	const SUB_FRED_MATERIAL_UUID = '3';
	const JOHN_DOE_PERSON_UUID = '4';
	const PLAYWRIGHTS_LTD_COMPANY_UUID = '5';
	const MID_FRED_MATERIAL_UUID = '11';
	const SUR_FRED_MATERIAL_UUID = '20';
	const FRANCIS_FLOB_PERSON_UUID = '28';
	const CURTAIN_UP_LTD_COMPANY_UUID = '29';
	const SUB_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '54';
	const BEATRICE_BAR_PERSON_UUID = '58';
	const STAGECRAFT_LTD_COMPANY_UUID = '59';
	const MID_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '68';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '83';
	const SUB_WALDO_MATERIAL_UUID = '93';
	const JANE_ROE_PERSON_UUID = '94';
	const FICTIONEERS_LTD_COMPANY_UUID = '95';
	const MID_WALDO_MATERIAL_UUID = '101';
	const SUR_WALDO_MATERIAL_UUID = '110';
	const SUB_WIBBLE_MATERIAL_UUID = '118';
	const QUINCY_QUX_PERSON_UUID = '119';
	const THEATRICALS_LTD_COMPANY_UUID = '120';
	const MID_WIBBLE_MATERIAL_UUID = '128';
	const SUR_WIBBLE_MATERIAL_UUID = '139';
	const SUB_HOGE_MATERIAL_UUID = '149';
	const CINERIGHTS_LTD_COMPANY_UUID = '152';
	const TALYSE_TATA_PERSON_UUID = '153';
	const MID_HOGE_MATERIAL_UUID = '161';
	const SUR_HOGE_MATERIAL_UUID = '174';
	const NATIONAL_THEATRE_VENUE_UUID = '185';
	const OLIVIER_THEATRE_VENUE_UUID = '186';
	const LYTTELTON_THEATRE_VENUE_UUID = '187';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '193';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '194';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '195';
	const SUB_FRED_LYTTELTON_PRODUCTION_UUID = '196';
	const MID_FRED_LYTTELTON_PRODUCTION_UUID = '198';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '200';
	const SUB_FRED_NOËL_COWARD_PRODUCTION_UUID = '202';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '203';
	const MID_FRED_NOËL_COWARD_PRODUCTION_UUID = '204';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '206';
	const SUB_PLUGH_OLIVIER_PRODUCTION_UUID = '208';
	const MID_PLUGH_OLIVIER_PRODUCTION_UUID = '210';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '212';
	const SUB_PLUGH_WYNDHAMS_PRODUCTION_UUID = '214';
	const WYNDHAMS_THEATRE_VENUE_UUID = '215';
	const MID_PLUGH_WYNDHAMS_PRODUCTION_UUID = '216';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '218';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '220';
	const MID_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '222';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '224';
	const SUB_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '226';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '227';
	const MID_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '228';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '230';
	const SUB_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '232';
	const MID_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '234';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '236';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '238';
	const MID_HOGE_NOËL_COWARD_PRODUCTION_UUID = '240';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '242';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '250';
	const WORDSMITH_AWARD_UUID = '251';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '262';
	const PLAYWRITING_PRIZE_AWARD_UUID = '263';
	const DRAMATISTS_MEDAL_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '274';
	const DRAMATISTS_MEDAL_AWARD_UUID = '275';
