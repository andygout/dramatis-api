...
describe('Award ceremonies with crediting sub-sub-materials', () => {
	...
	const MID_FRED_LYTTELTON_PRODUCTION_UUID = '230';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '234';
	const SUB_FRED_NOËL_COWARD_PRODUCTION_UUID = '238';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '240';
	const MID_FRED_NOËL_COWARD_PRODUCTION_UUID = '242';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '246';
	const SUB_PLUGH_OLIVIER_PRODUCTION_UUID = '250';
	const MID_PLUGH_OLIVIER_PRODUCTION_UUID = '254';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '258';
	const SUB_PLUGH_WYNDHAMS_PRODUCTION_UUID = '262';
	const WYNDHAMS_THEATRE_VENUE_UUID = '264';
	const MID_PLUGH_WYNDHAMS_PRODUCTION_UUID = '266';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '270';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '274';
	const MID_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '278';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '282';
	const SUB_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '286';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '288';
	const MID_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '290';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '294';
	const SUB_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '298';
	const MID_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '302';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '306';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '310';
	const MID_HOGE_NOËL_COWARD_PRODUCTION_UUID = '314';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '318';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '328';
	const WORDSMITH_AWARD_UUID = '329';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '340';
	const PLAYWRITING_PRIZE_AWARD_UUID = '341';
	const DRAMATISTS_MEDAL_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '352';
	const DRAMATISTS_MEDAL_AWARD_UUID = '353';
