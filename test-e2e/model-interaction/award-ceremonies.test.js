...
describe('Award ceremonies', () => {
	...
	const GARPLY_WYNDHAMS_PRODUCTION_UUID = '15';
	const WYNDHAMS_THEATRE_VENUE_UUID = '17';
	const PLUGH_PLAYHOUSE_PRODUCTION_UUID = '19';
	const PLAYHOUSE_THEATRE_VENUE_UUID = '21';
	const FRED_OLD_VIC_PRODUCTION_UUID = '23';
	const OLD_VIC_THEATRE_VENUE_UUID = '25';
	const WALDO_DORFMAN_PRODUCTION_UUID = '27';
	const WALDO_NOËL_COWARD_PRODUCTION_UUID = '31';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '33';
	const PIYO_HAROLD_PINTER_PRODUCTION_UUID = '35';
	const HAROLD_PINTER_THEATRE_VENUE_UUID = '37';
	const XYZZY_DORFMAN_PRODUCTION_UUID = '39';
	const XYZZY_PLAYHOUSE_PRODUCTION_UUID = '43';
	const WIBBLE_OLD_VIC_PRODUCTION_UUID = '47';
	const WIBBLE_WYNDHAMS_PRODUCTION_UUID = '51';
	const HOGE_ALMEIDA_PRODUCTION_UUID = '55';
	const ALMEIDA_THEATRE_VENUE_UUID = '57';
	const THUD_DUKE_OF_YORKS_PRODUCTION_UUID = '59';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '61';
	const TOTO_NOËL_COWARD_PRODUCTION_UUID = '63';
	const FUGA_OLIVIER_PRODUCTION_UUID = '67';
	const TUTU_PLAYHOUSE_PRODUCTION_UUID = '71';
	const GRAULT_ALMEIDA_PRODUCTION_UUID = '75';
	const GARPLY_MATERIAL_UUID = '81';
	const PLUGH_MATERIAL_UUID = '85';
	const FRED_MATERIAL_UUID = '89';
	const WALDO_MATERIAL_UUID = '93';
	const PIYO_MATERIAL_UUID = '97';
	const XYZZY_MATERIAL_UUID = '101';
	const WIBBLE_MATERIAL_UUID = '105';
	const HOGE_MATERIAL_UUID = '109';
	const THUD_MATERIAL_UUID = '113';
	const TOTO_MATERIAL_UUID = '117';
	const FUGA_MATERIAL_UUID = '121';
	const TUTU_MATERIAL_UUID = '125';
	const GRAULT_MATERIAL_UUID = '129';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '150';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '151';
	const JOHN_DOE_PERSON_UUID = '152';
	const CURTAIN_UP_LTD_COMPANY_UUID = '154';
	const JANE_ROE_PERSON_UUID = '155';
	const STAGECRAFT_LTD_COMPANY_UUID = '157';
	const FERDINAND_FOO_PERSON_UUID = '158';
	const BEATRICE_BAR_PERSON_UUID = '159';
	const BRANDON_BAZ_PERSON_UUID = '160';
	const THEATRICALS_LTD_COMPANY_UUID = '161';
	const QUINCY_QUX_PERSON_UUID = '162';
	const CLARA_QUUX_PERSON_UUID = '163';
	const CHRISTIAN_QUUZ_PERSON_UUID = '164';
	const CONOR_CORGE_PERSON_UUID = '165';
	const BACKSTAGE_LTD_COMPANY_UUID = '166';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '189';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '223';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '224';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '248';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_SEVENTEEN_AWARD_CEREMONY_UUID = '279';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '319';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '320';
