...
describe('Award ceremonies', () => {
	...
	const GARPLY_WYNDHAMS_PRODUCTION_UUID = '13';
	const WYNDHAMS_THEATRE_VENUE_UUID = '14';
	const PLUGH_PLAYHOUSE_PRODUCTION_UUID = '15';
	const PLAYHOUSE_THEATRE_VENUE_UUID = '16';
	const FRED_OLD_VIC_PRODUCTION_UUID = '17';
	const OLD_VIC_THEATRE_VENUE_UUID = '18';
	const WALDO_DORFMAN_PRODUCTION_UUID = '19';
	const WALDO_NOËL_COWARD_PRODUCTION_UUID = '21';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '22';
	const PIYO_HAROLD_PINTER_PRODUCTION_UUID = '23';
	const HAROLD_PINTER_THEATRE_VENUE_UUID = '24';
	const XYZZY_DORFMAN_PRODUCTION_UUID = '25';
	const XYZZY_PLAYHOUSE_PRODUCTION_UUID = '27';
	const WIBBLE_OLD_VIC_PRODUCTION_UUID = '29';
	const WIBBLE_WYNDHAMS_PRODUCTION_UUID = '31';
	const HOGE_ALMEIDA_PRODUCTION_UUID = '33';
	const ALMEIDA_THEATRE_VENUE_UUID = '34';
	const THUD_DUKE_OF_YORKS_PRODUCTION_UUID = '35';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '36';
	const TOTO_NOËL_COWARD_PRODUCTION_UUID = '37';
	const FUGA_OLIVIER_PRODUCTION_UUID = '39';
	const TUTU_PLAYHOUSE_PRODUCTION_UUID = '41';
	const GRAULT_ALMEIDA_PRODUCTION_UUID = '43';
	const GARPLY_MATERIAL_UUID = '46';
	const PLUGH_MATERIAL_UUID = '48';
	const FRED_MATERIAL_UUID = '50';
	const WALDO_MATERIAL_UUID = '52';
	const PIYO_MATERIAL_UUID = '54';
	const XYZZY_MATERIAL_UUID = '56';
	const WIBBLE_MATERIAL_UUID = '58';
	const HOGE_MATERIAL_UUID = '60';
	const THUD_MATERIAL_UUID = '62';
	const TOTO_MATERIAL_UUID = '64';
	const FUGA_MATERIAL_UUID = '66';
	const TUTU_MATERIAL_UUID = '68';
	const GRAULT_MATERIAL_UUID = '70';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '90';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '91';
	const JOHN_DOE_PERSON_UUID = '92';
	const CURTAIN_UP_LTD_COMPANY_UUID = '94';
	const JANE_ROE_PERSON_UUID = '95';
	const STAGECRAFT_LTD_COMPANY_UUID = '97';
	const FERDINAND_FOO_PERSON_UUID = '98';
	const BEATRICE_BAR_PERSON_UUID = '99';
	const BRANDON_BAZ_PERSON_UUID = '100';
	const THEATRICALS_LTD_COMPANY_UUID = '101';
	const QUINCY_QUX_PERSON_UUID = '102';
	const CLARA_QUUX_PERSON_UUID = '103';
	const CHRISTIAN_QUUZ_PERSON_UUID = '104';
	const CONOR_CORGE_PERSON_UUID = '105';
	const BACKSTAGE_LTD_COMPANY_UUID = '106';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '129';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '163';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '164';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '188';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_SEVENTEEN_AWARD_CEREMONY_UUID = '219';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '259';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '260';
