...
describe('Award ceremonies', () => {
	...
	const PLUGH_PLAYHOUSE_PRODUCTION_UUID = '17';
	const PLAYHOUSE_THEATRE_VENUE_UUID = '19';
	const FRED_OLD_VIC_PRODUCTION_UUID = '20';
	const OLD_VIC_THEATRE_VENUE_UUID = '22';
	const WALDO_DORFMAN_PRODUCTION_UUID = '23';
	const WALDO_NOËL_COWARD_PRODUCTION_UUID = '26';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '28';
	const PIYO_HAROLD_PINTER_PRODUCTION_UUID = '29';
	const HAROLD_PINTER_THEATRE_VENUE_UUID = '31';
	const XYZZY_DORFMAN_PRODUCTION_UUID = '32';
	const XYZZY_PLAYHOUSE_PRODUCTION_UUID = '35';
	const WIBBLE_OLD_VIC_PRODUCTION_UUID = '38';
	const WIBBLE_WYNDHAMS_PRODUCTION_UUID = '41';
	const HOGE_ALMEIDA_PRODUCTION_UUID = '44';
	const ALMEIDA_THEATRE_VENUE_UUID = '46';
	const THUD_DUKE_OF_YORKS_PRODUCTION_UUID = '47';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '49';
	const TOTO_NOËL_COWARD_PRODUCTION_UUID = '50';
	const FUGA_OLIVIER_PRODUCTION_UUID = '53';
	const TUTU_PLAYHOUSE_PRODUCTION_UUID = '56';
	const GRAULT_ALMEIDA_PRODUCTION_UUID = '59';
	const GARPLY_MATERIAL_UUID = '64';
	const PLUGH_MATERIAL_UUID = '68';
	const FRED_MATERIAL_UUID = '72';
	const WALDO_MATERIAL_UUID = '76';
	const PIYO_MATERIAL_UUID = '80';
	const XYZZY_MATERIAL_UUID = '84';
	const WIBBLE_MATERIAL_UUID = '88';
	const HOGE_MATERIAL_UUID = '92';
	const THUD_MATERIAL_UUID = '96';
	const TOTO_MATERIAL_UUID = '100';
	const FUGA_MATERIAL_UUID = '104';
	const TUTU_MATERIAL_UUID = '108';
	const GRAULT_MATERIAL_UUID = '112';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '133';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '134';
	const JOHN_DOE_PERSON_UUID = '135';
	const CURTAIN_UP_LTD_COMPANY_UUID = '137';
	const JANE_ROE_PERSON_UUID = '138';
	const STAGECRAFT_LTD_COMPANY_UUID = '140';
	const FERDINAND_FOO_PERSON_UUID = '141';
	const BEATRICE_BAR_PERSON_UUID = '142';
	const BRANDON_BAZ_PERSON_UUID = '143';
	const THEATRICALS_LTD_COMPANY_UUID = '144';
	const QUINCY_QUX_PERSON_UUID = '145';
	const CLARA_QUUX_PERSON_UUID = '146';
	const CHRISTIAN_QUUZ_PERSON_UUID = '147';
	const CONOR_CORGE_PERSON_UUID = '148';
	const BACKSTAGE_LTD_COMPANY_UUID = '149';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '172';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '206';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '207';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '231';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_SEVENTEEN_AWARD_CEREMONY_UUID = '262';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '302';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '303';
