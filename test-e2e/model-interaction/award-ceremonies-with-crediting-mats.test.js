...
describe('Award ceremonies with crediting materials', () => {
	...
	const NATIONAL_THEATRE_VENUE_UUID = '129';
	const OLIVIER_THEATRE_VENUE_UUID = '130';
	const LYTTELTON_THEATRE_VENUE_UUID = '131';
	const COTTESLOE_THEATRE_VENUE_UUID = '132';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '138';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '139';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '140';
	const PIYO_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '141';
	const PIYO_WYNDHAMS_PRODUCTION_UUID = '144';
	const WYNDHAMS_THEATRE_VENUE_UUID = '146';
	const WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '147';
	const WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '150';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '152';
	const XYZZY_OLIVIER_PRODUCTION_UUID = '153';
	const XYZZY_DUKE_OF_YORKS_PRODUCTION_UUID = '156';
	const FRED_LYTTELTON_PRODUCTION_UUID = '159';
	const FRED_NOËL_COWARD_PRODUCTION_UUID = '162';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '164';
	const GARPLY_ALMEIDA_PRODUCTION_UUID = '165';
	const PLUGH_LYTTELTON_PRODUCTION_UUID = '168';
	const PLUGH_WYNDHAMS_PRODUCTION_UUID = '171';
	const HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '174';
	const HOGE_NOËL_COWARD_PRODUCTION_UUID = '177';
	const THUD_PLAYHOUSE_PRODUCTION_UUID = '180';
	const PLAYHOUSE_THEATRE_VENUE_UUID = '182';
	const TUTU_OLD_VIC_PRODUCTION_UUID = '183';
	const TOTO_COTTESLOE_PRODUCTION_UUID = '186';
	const TOTO_GIELGUD_PRODUCTION_UUID = '189';
	const GIELGUD_THEATRE_VENUE_UUID = '191';
	const FUGA_ALMEIDA_PRODUCTION_UUID = '192';
	const GRAULT_GIELGUD_PRODUCTION_UUID = '195';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '203';
	const WORDSMITH_AWARD_UUID = '204';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '213';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '223';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '233';
	const PLAYWRITING_PRIZE_AWARD_UUID = '234';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '243';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_SEVEN_AWARD_CEREMONY_UUID = '253';
