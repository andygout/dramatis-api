...
describe('Award ceremonies with crediting materials', () => {
	...
	const PIYO_MATERIAL_UUID = '4';
	const FERDINAND_FOO_PERSON_UUID = '5';
	const CLARA_QUUX_PERSON_UUID = '6';
	const SONGBIRDS_LTD_COMPANY_UUID = '7';
	const WALDO_MATERIAL_UUID = '11';
	const JANE_ROE_PERSON_UUID = '12';
	const FICTIONEERS_LTD_COMPANY_UUID = '13';
	const WIBBLE_MATERIAL_UUID = '18';
	const QUINCY_QUX_PERSON_UUID = '19';
	const THEATRICALS_LTD_COMPANY_UUID = '20';
	const XYZZY_MATERIAL_UUID = '27';
	const CONOR_CORGE_PERSON_UUID = '28';
	const SCRIBES_LTD_COMPANY_UUID = '29';
	const BRANDON_BAZ_PERSON_UUID = '30';
	const CREATORS_LTD_COMPANY_UUID = '31';
	const FRED_MATERIAL_UUID = '35';
	const JOHN_DOE_PERSON_UUID = '36';
	const PLAYWRIGHTS_LTD_COMPANY_UUID = '37';
	const PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '45';
	const FRANCIS_FLOB_PERSON_UUID = '46';
	const CURTAIN_UP_LTD_COMPANY_UUID = '47';
	const PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '54';
	const BEATRICE_BAR_PERSON_UUID = '58';
	const STAGECRAFT_LTD_COMPANY_UUID = '59';
	const HOGE_MATERIAL_UUID = '65';
	const CINERIGHTS_LTD_COMPANY_UUID = '68';
	const TALYSE_TATA_PERSON_UUID = '69';
	const THUD_MATERIAL_UUID = '72';
	const TOTO_MATERIAL_UUID = '83';
	const GRAULT_MATERIAL_UUID = '94';
	const NATIONAL_THEATRE_VENUE_UUID = '103';
	const OLIVIER_THEATRE_VENUE_UUID = '104';
	const LYTTELTON_THEATRE_VENUE_UUID = '105';
	const COTTESLOE_THEATRE_VENUE_UUID = '106';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '112';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '113';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '114';
	const PIYO_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '115';
	const PIYO_WYNDHAMS_PRODUCTION_UUID = '117';
	const WYNDHAMS_THEATRE_VENUE_UUID = '118';
	const WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '119';
	const WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '121';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '122';
	const XYZZY_OLIVIER_PRODUCTION_UUID = '123';
	const XYZZY_DUKE_OF_YORKS_PRODUCTION_UUID = '125';
	const FRED_LYTTELTON_PRODUCTION_UUID = '127';
	const FRED_NOËL_COWARD_PRODUCTION_UUID = '129';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '130';
	const GARPLY_ALMEIDA_PRODUCTION_UUID = '131';
	const PLUGH_LYTTELTON_PRODUCTION_UUID = '133';
	const PLUGH_WYNDHAMS_PRODUCTION_UUID = '135';
	const HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '137';
	const HOGE_NOËL_COWARD_PRODUCTION_UUID = '139';
	const THUD_PLAYHOUSE_PRODUCTION_UUID = '141';
	const PLAYHOUSE_THEATRE_VENUE_UUID = '142';
	const TUTU_OLD_VIC_PRODUCTION_UUID = '143';
	const TOTO_COTTESLOE_PRODUCTION_UUID = '145';
	const TOTO_GIELGUD_PRODUCTION_UUID = '147';
	const GIELGUD_THEATRE_VENUE_UUID = '148';
	const FUGA_ALMEIDA_PRODUCTION_UUID = '149';
	const GRAULT_GIELGUD_PRODUCTION_UUID = '151';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '158';
	const WORDSMITH_AWARD_UUID = '159';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '168';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '178';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '188';
	const PLAYWRITING_PRIZE_AWARD_UUID = '189';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '198';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_SEVEN_AWARD_CEREMONY_UUID = '208';
