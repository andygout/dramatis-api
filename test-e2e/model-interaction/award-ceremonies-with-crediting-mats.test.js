...
const PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = 'PLUGH_MATERIAL_1_UUID';
const FRANCIS_FLOB_PERSON_UUID = 'FRANCIS_FLOB_PERSON_UUID';
const CURTAIN_UP_LTD_COMPANY_UUID = 'CURTAIN_UP_LTD_COMPANY_UUID';
const PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = 'PLUGH_MATERIAL_2_UUID';
...
const PIYO_WYNDHAMS_PRODUCTION_UUID = 'PIYO_PRODUCTION_2_UUID';
...
const WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = 'WIBBLE_PRODUCTION_2_UUID';
...
const XYZZY_DUKE_OF_YORKS_PRODUCTION_UUID = 'XYZZY_PRODUCTION_2_UUID';
const FRED_LYTTELTON_PRODUCTION_UUID = 'FRED_PRODUCTION_UUID';
const FRED_NOËL_COWARD_PRODUCTION_UUID = 'FRED_PRODUCTION_2_UUID';
...
const PLUGH_WYNDHAMS_PRODUCTION_UUID = 'PLUGH_PRODUCTION_2_UUID';
const HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = 'HOGE_PRODUCTION_UUID';
const HOGE_NOËL_COWARD_PRODUCTION_UUID = 'HOGE_PRODUCTION_2_UUID';
...
const TOTO_GIELGUD_PRODUCTION_UUID = 'TOTO_PRODUCTION_2_UUID';
...
const WORDSMITH_AWARD_2009_AWARD_CEREMONY_UUID = '2009_AWARD_CEREMONY_2_UUID';
...
const WORDSMITH_AWARD_2008_AWARD_CEREMONY_UUID = '2008_AWARD_CEREMONY_2_UUID';
const PLAYWRITING_PRIZE_2008_AWARD_CEREMONY_UUID = '2008_AWARD_CEREMONY_4_UUID';
const PLAYWRITING_PRIZE_AWARD_UUID = 'PLAYWRITING_PRIZE_AWARD_UUID';
const PLAYWRITING_PRIZE_2009_AWARD_CEREMONY_UUID = '2009_AWARD_CEREMONY_4_UUID';
const PLAYWRITING_PRIZE2007AWARD_CEREMONY_UUID = '2007_AWARD_CEREMONY_2_UUID';
...
describe('Award ceremonies with crediting materials', () => {
	before(async () => {
		...
		wordsmithAward2009AwardCeremony = await request(app).get(
			`/award-ceremonies/${WORDSMITH_AWARD_2009_AWARD_CEREMONY_UUID}`
		);
		...
		claraQuuxPerson = await request(app).get(`/people/${CLARA_QUUX_PERSON_UUID}`);

		songbirdsLtdCompany = await request(app).get(`/companies/${SONGBIRDS_LTD_COMPANY_UUID}`);

		beatriceBarPerson = await request(app).get(`/people/${BEATRICE_BAR_PERSON_UUID}`);

		theatricalsLtdCompany = await request(app).get(`/companies/${THEATRICALS_LTD_COMPANY_UUID}`);
		...
		brandonBazPerson = await request(app).get(`/people/${BRANDON_BAZ_PERSON_UUID}`);

		creatorsLtdCompany = await request(app).get(`/companies/${CREATORS_LTD_COMPANY_UUID}`);

		plughOriginalVersionMaterial = await request(app).get(`/materials/${PLUGH_ORIGINAL_VERSION_MATERIAL_UUID}`);
