...
describe('Award ceremonies with crediting materials', () => {
	...
	const PIYO_WYNDHAMS_PRODUCTION_UUID = '145';
	const WYNDHAMS_THEATRE_VENUE_UUID = '147';
	const WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '149';
	const WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '153';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '155';
	const XYZZY_OLIVIER_PRODUCTION_UUID = '157';
	const XYZZY_DUKE_OF_YORKS_PRODUCTION_UUID = '161';
	const FRED_LYTTELTON_PRODUCTION_UUID = '165';
	const FRED_NOËL_COWARD_PRODUCTION_UUID = '169';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '171';
	const GARPLY_ALMEIDA_PRODUCTION_UUID = '173';
	const PLUGH_LYTTELTON_PRODUCTION_UUID = '177';
	const PLUGH_WYNDHAMS_PRODUCTION_UUID = '181';
	const HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '185';
	const HOGE_NOËL_COWARD_PRODUCTION_UUID = '189';
	const THUD_PLAYHOUSE_PRODUCTION_UUID = '193';
	const PLAYHOUSE_THEATRE_VENUE_UUID = '195';
	const TUTU_OLD_VIC_PRODUCTION_UUID = '197';
	const TOTO_COTTESLOE_PRODUCTION_UUID = '201';
	const TOTO_GIELGUD_PRODUCTION_UUID = '205';
	const GIELGUD_THEATRE_VENUE_UUID = '207';
	const FUGA_ALMEIDA_PRODUCTION_UUID = '209';
	const GRAULT_GIELGUD_PRODUCTION_UUID = '213';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '222';
	const WORDSMITH_AWARD_UUID = '223';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '232';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '242';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '252';
	const PLAYWRITING_PRIZE_AWARD_UUID = '253';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '262';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_SEVEN_AWARD_CEREMONY_UUID = '272';
