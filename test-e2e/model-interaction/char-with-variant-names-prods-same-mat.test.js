...
describe('Character with variant names from productions of the same material', () => {
	...
	const ANDREW_SCOTT_PERSON_UUID = '16';
	const DAVID_RINTOUL_PERSON_UUID = '17';
	const HAMLET_NOVELLO_PRODUCTION_UUID = '18';
	const NOVELLO_THEATRE_VENUE_UUID = '20';
	const DAVID_TENNANT_PERSON_UUID = '22';
	const PATRICK_STEWART_PERSON_UUID = '23';
	const HAMLET_WYNDHAMS_PRODUCTION_UUID = '24';
	const WYNDHAMS_THEATRE_VENUE_UUID = '26';
	const JUDE_LAW_PERSON_UUID = '28';
	const PETER_EYRE_PERSON_UUID = '29';
