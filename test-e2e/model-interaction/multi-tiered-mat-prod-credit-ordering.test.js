...
describe('Ordering of multi-tiered materials/productions credits', () => {
	...
	const NICOLAS_KENT_PERSON_UUID = '118';
	const TRICYCLE_THEATRE_COMPANY_UUID = '119';
	const ZOË_INGENHAAG_PERSON_UUID = '120';
	const RICK_WARDEN_PERSON_UUID = '121';
	const HOWARD_HARRISON_PERSON_UUID = '122';
	const LIGHTING_DESIGN_LTD_COMPANY_UUID = '123';
	const JACK_KNOWLES_PERSON_UUID = '124';
	const LIZZIE_CHAPMAN_PERSON_UUID = '125';
	const STAGE_MANAGEMENT_LTD_COMPANY_UUID = '126';
	const CHARLOTTE_PADGHAM_PERSON_UUID = '127';
	const DURANDS_LINE_TRICYCLE_PRODUCTION_UUID = '128';
	const CAMPAIGN_TRICYCLE_PRODUCTION_UUID = '142';
	const PART_ONE_INVASIONS_AND_INDEPENDENCE_TRICYCLE_PRODUCTION_UUID = '156';
	const BLACK_TULIPS_TRICYCLE_PRODUCTION_UUID = '170';
	const BLOOD_AND_GIFTS_TRICYCLE_PRODUCTION_UUID = '184';
	const MINISKIRTS_OF_KABUL_TRICYCLE_PRODUCTION_UUID = '198';
	const PART_TWO_COMMUNISM_THE_MUJAHIDEEN_AND_THE_TALIBAN_TRICYCLE_PRODUCTION_UUID = '212';
	const HONEY_TRICYCLE_PRODUCTION_UUID = '226';
	const THE_NIGHT_IS_DARKEST_BEFORE_THE_DAWN_TRICYCLE_PRODUCTION_UUID = '240';
	const ON_THE_SIDE_OF_THE_ANGELS_TRICYCLE_PRODUCTION_UUID = '254';
	const PART_THREE_ENDURING_FREEDOM_TRICYCLE_PRODUCTION_UUID = '268';
	const THE_GREAT_GAME_AFGHANISTAN_TRICYCLE_PRODUCTION_UUID = '282';
	const WALDO_MATERIAL_UUID = '298';
	const WIBBLE_MATERIAL_UUID = '303';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '306';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '308';
	const SUB_WIBBLE_PART_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '310';
	const SUB_WIBBLE_PART_III_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '314';
	const MID_WIBBLE_SECTION_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '318';
	const SUB_WIBBLE_PART_IV_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '322';
	const SUB_WIBBLE_PART_V_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '326';
	const SUB_WIBBLE_PART_VI_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '330';
	const MID_WIBBLE_SECTION_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '334';
	const SUB_WIBBLE_PART_VII_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '338';
	const SUB_WIBBLE_PART_VIII_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '342';
	const SUB_WIBBLE_PART_IX_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '346';
	const MID_WIBBLE_SECTION_III_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '350';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '354';
