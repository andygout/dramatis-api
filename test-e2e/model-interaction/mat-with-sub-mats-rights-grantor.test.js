...
describe('Material with sub-materials and rights grantor credits thereof', () => {
	...
	const THE_CHRONICLES_OF_NARNIA_SERIES_OF_NOVELS_MATERIAL_UUID = '11';
	const THE_LION_THE_WITCH_AND_THE_WARDROBE_PLAY_MATERIAL_UUID = '21';
	const ADAM_PECK_PERSON_UUID = '23';
	const C_S_LEWIS_SOCIETY_COMPANY_UUID = '25';
	const SARAH_SELDEN_PERSON_UUID = '26';
	const THE_CHRONICLES_OF_NARNIA_PLAYS_MATERIAL_UUID = '33';
