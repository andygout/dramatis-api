...
describe('Character with variant names from productions of different materials', () => {
	...
	const PATRICK_MALAHIDE_PERSON_UUID = '37';
	const ROSENCRANTZ_AND_GUILDENSTERN_ARE_DEAD_HAYMARKET_PRODUCTION_UUID = '38';
	const THEATRE_ROYAL_HAYMARKET_VENUE_UUID = '40';
	const JACK_HAWKINS_PERSON_UUID = '42';
	const JAMES_SIMMONS_PERSON_UUID = '43';
	const FORTINBRAS_LA_JOLLA_PRODUCTION_UUID = '44';
	const LA_JOLLA_PLAYHOUSE_VENUE_UUID = '46';
	const DON_REILLY_PERSON_UUID = '48';
	const JONATHAN_FREEMAN_PERSON_UUID = '49';
	const HAMLETMACHINE_TEATRO_SAN_NICOLÒ_PRODUCTION_UUID = '50';
	const TEATRO_SAN_NICOLÒ_VENUE_UUID = '52';
	const GABRIELE_CICIRELLO_PERSON_UUID = '54';
	const RENATO_CIVELLO_PERSON_UUID = '55';
