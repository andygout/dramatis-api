...
describe('Character with variant names from productions of different materials', () => {
	...
	const HAMLET_MATERIAL_UUID = '3';
	const HAMLET_CHARACTER_UUID = '4';
	const CLAUDIUS_CHARACTER_UUID = '5';
	const ROSENCRANTZ_AND_GUILDENSTERN_ARE_DEAD_MATERIAL_UUID = '9';
	const FORTINBRAS_MATERIAL_UUID = '15';
	const HAMLETMACHINE_MATERIAL_UUID = '21';
	...
	const TEATRO_SAN_NICOLÒ_VENUE_UUID = '41';
