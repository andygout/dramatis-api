...
describe('Cast member with multiple production credits', () => {
	...
	const SUSANNAH_FELLOWS_PERSON_UUID = '4';
	const CITY_OF_ANGELS_PRINCE_OF_WALES_PRODUCTION_UUID = '5';
	const PRINCE_OF_WALES_THEATRE_VENUE_UUID = '7';
	const ENRON_CHICHESTER_FESTIVAL_PRODUCTION_UUID = '10';
	const CHICHESTER_FESTIVAL_THEATRE_VENUE_UUID = '12';
