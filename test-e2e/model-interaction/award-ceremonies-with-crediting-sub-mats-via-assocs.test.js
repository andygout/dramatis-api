...
describe('Award ceremonies with crediting sub-materials (with person/company/material nominations gained via associations to sur and sub-materials)', () => {
	...
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '196';
	const SUB_FRED_PART_I_NOËL_COWARD_PRODUCTION_UUID = '200';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '202';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '204';
	const SUB_PLUGH_PART_I_OLIVIER_PRODUCTION_UUID = '208';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '212';
	const SUB_PLUGH_PART_I_WYNDHAMS_PRODUCTION_UUID = '216';
	const WYNDHAMS_THEATRE_VENUE_UUID = '218';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '220';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '224';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '228';
	const SUB_WIBBLE_PART_I_DUKE_OF_YORKS_PRODUCTION_UUID = '232';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '234';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '236';
	const SUB_HOGE_PART_I_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '240';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '244';
	const SUB_HOGE_PART_I_NOËL_COWARD_PRODUCTION_UUID = '248';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '252';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '262';
	const WORDSMITH_AWARD_UUID = '263';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '274';
	const PLAYWRITING_PRIZE_AWARD_UUID = '275';
	const SCRIPTING_SHIELD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '286';
	const SCRIPTING_SHIELD_AWARD_UUID = '287';
