...
describe('Award ceremonies with crediting sub-materials (with person/company/material nominations gained via associations to sur and sub-materials)', () => {
	...
	const SUR_FRED_MATERIAL_UUID = '15';
	const JOHN_DOE_SR_PERSON_UUID = '16';
	const SUR_PLAYWRIGHTS_LTD_COMPANY_UUID = '17';
	const SUB_PLUGH_PART_I_ORIGINAL_VERSION_MATERIAL_UUID = '23';
	const FRANCIS_FLOB_JR_PERSON_UUID = '24';
	const SUB_CURTAIN_UP_LTD_COMPANY_UUID = '25';
	const SUR_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '35';
	const FRANCIS_FLOB_SR_PERSON_UUID = '36';
	const SUR_CURTAIN_UP_LTD_COMPANY_UUID = '37';
	const SUB_PLUGH_PART_I_SUBSEQUENT_VERSION_MATERIAL_UUID = '46';
	const SUB_PLUGH_PART_II_SUBSEQUENT_VERSION_MATERIAL_UUID = '54';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '66';
	const SUB_WALDO_PART_I_MATERIAL_UUID = '77';
	const JANE_ROE_JR_PERSON_UUID = '78';
	const SUB_FICTIONEERS_LTD_COMPANY_UUID = '79';
	const SUR_WALDO_MATERIAL_UUID = '89';
	const JANE_ROE_SR_PERSON_UUID = '90';
	const SUR_FICTIONEERS_LTD_COMPANY_UUID = '91';
	const SUB_WIBBLE_PART_I_MATERIAL_UUID = '98';
	const SUB_WIBBLE_PART_II_MATERIAL_UUID = '103';
	const SUR_WIBBLE_MATERIAL_UUID = '112';
	const SUB_HOGE_PART_I_MATERIAL_UUID = '123';
	const SUB_CINERIGHTS_LTD_COMPANY_UUID = '126';
	const TALYSE_TATA_JR_PERSON_UUID = '127';
	const SUB_HOGE_PART_II_MATERIAL_UUID = '129';
	const SUR_HOGE_MATERIAL_UUID = '139';
	const SUR_CINERIGHTS_LTD_COMPANY_UUID = '142';
	const TALYSE_TATA_SR_PERSON_UUID = '143';
	const NATIONAL_THEATRE_VENUE_UUID = '151';
	const OLIVIER_THEATRE_VENUE_UUID = '152';
	const LYTTELTON_THEATRE_VENUE_UUID = '153';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '159';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '160';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '161';
	const SUB_FRED_PART_I_LYTTELTON_PRODUCTION_UUID = '162';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '164';
	const SUB_FRED_PART_I_NOËL_COWARD_PRODUCTION_UUID = '166';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '167';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '168';
	const SUB_PLUGH_PART_I_OLIVIER_PRODUCTION_UUID = '170';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '172';
	const SUB_PLUGH_PART_I_WYNDHAMS_PRODUCTION_UUID = '174';
	const WYNDHAMS_THEATRE_VENUE_UUID = '175';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '176';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '178';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '180';
	const SUB_WIBBLE_PART_I_DUKE_OF_YORKS_PRODUCTION_UUID = '182';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '183';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '184';
	const SUB_HOGE_PART_I_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '186';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '188';
	const SUB_HOGE_PART_I_NOËL_COWARD_PRODUCTION_UUID = '190';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '192';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '200';
	const WORDSMITH_AWARD_UUID = '201';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '212';
	const PLAYWRITING_PRIZE_AWARD_UUID = '213';
	const SCRIPTING_SHIELD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '224';
	const SCRIPTING_SHIELD_AWARD_UUID = '225';
