...
describe('Award ceremonies with sub-materials and sub-productions', () => {
	...
	const SUR_HOGE_MATERIAL_UUID = '13';
	const SUB_WIBBLE_PART_I_MATERIAL_UUID = '18';
	const SUB_WIBBLE_PART_II_MATERIAL_UUID = '22';
	const SUR_WIBBLE_MATERIAL_UUID = '30';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '34';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '36';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '38';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '42';
	const SUB_WIBBLE_PART_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '46';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '50';
	...
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '85';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '86';
