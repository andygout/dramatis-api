...
describe('Award ceremonies with sub-materials and sub-productions', () => {
	...
	const SUR_HOGE_MATERIAL_UUID = '10';
	const SUB_WIBBLE_PART_I_MATERIAL_UUID = '13';
	const SUB_WIBBLE_PART_II_MATERIAL_UUID = '15';
	const SUR_WIBBLE_MATERIAL_UUID = '21';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '24';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '25';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '26';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '28';
	const SUB_WIBBLE_PART_II_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '30';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '32';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '41';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '42';
	const CONOR_CORGE_PERSON_UUID = '43';
	const STAGECRAFT_LTD_COMPANY_UUID = '44';
	const FERDINAND_FOO_PERSON_UUID = '45';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '55';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '56';
	const CRITICS_CIRCLE_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '65';
	const CRITICS_CIRCLE_THEATRE_AWARDS_AWARD_UUID = '66';
