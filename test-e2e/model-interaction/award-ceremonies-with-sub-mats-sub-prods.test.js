...
describe('Award ceremonies with sub-materials and sub-productions', () => {
	...
	const SUR_HOGE_MATERIAL_UUID = '12';
	const SUB_WIBBLE_MATERIAL_UUID = '17';
	const SUR_WIBBLE_MATERIAL_UUID = '23';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '26';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '28';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '29';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '32';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '35';
	const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '45';
	const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '46';
	const CONOR_CORGE_PERSON_UUID = '47';
	const STAGECRAFT_LTD_COMPANY_UUID = '48';
	const FERDINAND_FOO_PERSON_UUID = '49';
	const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '59';
	const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '60';
