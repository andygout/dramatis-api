...
describe('Material with sub-materials and source materials thereof', () => {
	...
	const BRING_UP_THE_BODIES_NOVEL_MATERIAL_UUID = '3';
	const HILARY_MANTEL_PERSON_UUID = '4';
	const THE_MANTEL_GROUP_COMPANY_UUID = '5';
	const THE_WOLF_HALL_TRILOGY_NOVELS_MATERIAL_UUID = '11';
	const BRING_UP_THE_BODIES_PLAY_MATERIAL_UUID = '20';
	const MIKE_POULTON_PERSON_UUID = '21';
	const ROYAL_SHAKESPEARE_COMPANY_UUID = '22';
	const THOMAS_CROMWELL_CHARACTER_UUID = '24';
	const THE_WOLF_HALL_TRILOGY_PLAYS_MATERIAL_UUID = '31';
	const BRING_UP_THE_BODIES_SWAN_THEATRE_PRODUCTION_UUID = '36';
	const SWAN_THEATRE_VENUE_UUID = '38';
	const THE_WOLF_HALL_TRILOGY_SWAN_THEATRE_PRODUCTION_UUID = '39';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_NOVEL_MATERIAL_UUID = '45';
	const CHARLES_DICKENS_PERSON_UUID = '46';
	const DOMBEY_AND_SON_LTD_COMPANY_UUID = '47';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_PART_I_PLAY_MATERIAL_UUID = '52';
	const DAVID_EDGAR_PERSON_UUID = '53';
	const EDGAR_WORKS_LTD_COMPANY_UUID = '54';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_PLAYS_MATERIAL_UUID = '62';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_PART_I_GIELGUD_THEATRE_PRODUCTION_UUID = '67';
	const GIELGUD_THEATRE_VENUE_UUID = '69';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_GIELGUD_THEATRE_PRODUCTION_UUID = '70';
