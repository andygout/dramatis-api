...
describe('Material with sub-materials and source materials thereof', () => {
	...
	const THE_WOLF_HALL_TRILOGY_SWAN_THEATRE_PRODUCTION_UUID = '48';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_NOVEL_MATERIAL_UUID = '56';
	const CHARLES_DICKENS_PERSON_UUID = '58';
	const DOMBEY_AND_SON_LTD_COMPANY_UUID = '59';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_PART_I_PLAY_MATERIAL_UUID = '65';
	const DAVID_EDGAR_PERSON_UUID = '67';
	const EDGAR_WORKS_LTD_COMPANY_UUID = '68';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_PLAYS_MATERIAL_UUID = '77';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_PART_I_GIELGUD_THEATRE_PRODUCTION_UUID = '83';
	const GIELGUD_THEATRE_VENUE_UUID = '85';
	const THE_LIFE_AND_ADVENTURES_OF_NICHOLAS_NICKLEBY_GIELGUD_THEATRE_PRODUCTION_UUID = '87';
