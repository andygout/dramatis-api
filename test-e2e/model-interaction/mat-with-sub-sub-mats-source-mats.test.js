...
describe('Material with sub-sub-materials and source materials thereof', () => {
	...
	const THE_OLD_TESTAMENT_RELIGIOUS_TEXT_MATERIAL_UUID = '14';
	const THE_BIBLE_KING_JAMES_VERSION_RELIGIOUS_TEXT_MATERIAL_UUID = '25';
	const GODBLOG_PLAY_MATERIAL_UUID = '36';
	const JEANETTE_WINTERSON_PERSON_UUID = '38';
	const ONLY_FRUITS_COMPANY_UUID = '39';
	const GOD_CHARACTER_UUID = '41';
	const THE_BOOKS_OF_THE_OLD_TESTAMENT_PLAYS_MATERIAL_UUID = '47';
