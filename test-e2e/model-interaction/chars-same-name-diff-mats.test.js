...
describe('Different characters with the same name from different materials', () => {
	...
	const OSCAR_PEARCE_PERSON_UUID = '20';
	const TRYSTAN_GRAVELLE_PERSON_UUID = '21';
	const TITUS_ANDRONICUS_GLOBE_PRODUCTION_UUID = '22';
	const SHAKESPEARES_GLOBE_VENUE_UUID = '24';
	const RICHARD_RIDDELL_PERSON_UUID = '26';
	const SAM_ALEXANDER_PERSON_UUID = '27';
