...
describe('Material with sub-sub-materials and rights grantor credits thereof', () => {
	...
	const THE_LORD_OF_THE_RINGS_TRILOGY_OF_NOVELS_MATERIAL_UUID = '11';
	const TOLKIENS_LEGENDARIUM_BODY_OF_WRITING_MATERIAL_UUID = '20';
	const THE_FELLOWSHIP_OF_THE_RINGS_PLAY_MATERIAL_UUID = '30';
	const SHAUN_MCKENNA_PERSON_UUID = '32';
	const THE_TOLKIEN_ESTATE_COMPANY_UUID = '34';
	const BAILLIE_TOLKIEN_PERSON_UUID = '35';
	const THE_LORD_OF_THE_RINGS_TRILOGY_OF_PLAYS_MATERIAL_UUID = '42';
	const TOLKIENS_LEGENDARIUM_COLLECTION_OF_PLAYS_MATERIAL_UUID = '53';
