...
describe('Material with sub-sub-materials and rights grantor credits thereof', () => {
	...
	const THE_FELLOWSHIP_OF_THE_RING_NOVEL_MATERIAL_UUID = '3';
	const J_R_R_TOLKIEN_PERSON_UUID = '5';
	const THE_LORD_OF_THE_RINGS_TRILOGY_OF_NOVELS_MATERIAL_UUID = '10';
	const TOLKIENS_LEGENDARIUM_BODY_OF_WRITING_MATERIAL_UUID = '18';
	const THE_FELLOWSHIP_OF_THE_RINGS_PLAY_MATERIAL_UUID = '28';
	const SHAUN_MCKENNA_PERSON_UUID = '30';
	const THE_TOLKIEN_ESTATE_COMPANY_UUID = '32';
	const BAILLIE_TOLKIEN_PERSON_UUID = '33';
	const THE_LORD_OF_THE_RINGS_TRILOGY_OF_PLAYS_MATERIAL_UUID = '39';
	const TOLKIENS_LEGENDARIUM_COLLECTION_OF_PLAYS_MATERIAL_UUID = '49';
