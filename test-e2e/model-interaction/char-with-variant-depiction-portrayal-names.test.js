...
describe('Character with variant depiction and portrayal names', () => {
	...
	const ALEX_HASSELL_PERSON_UUID = '40';
	const ANTONY_SHER_PERSON_UUID = '41';
	const HENRY_IV_PART_2_ROYAL_SHAKESPEARE_PRODUCTION_UUID = '42';
	const HENRY_V_ROYAL_SHAKESPEARE_PRODUCTION_UUID = '48';
	const SIMON_THORP_PERSON_UUID = '53';
	const HENRY_IV_PART_1_NATIONAL_PRODUCTION_UUID = '54';
	const NATIONAL_THEATRE_VENUE_UUID = '56';
	const MATTHEW_MACFADYEN_PERSON_UUID = '58';
	const MICHAEL_GAMBON_PERSON_UUID = '59';
	const HENRY_IV_PART_2_NATIONAL_PRODUCTION_UUID = '60';
	const HENRY_V_NATIONAL_PRODUCTION_UUID = '66';
	const ADRIAN_LESTER_PERSON_UUID = '70';
	const IAN_HOGG_PERSON_UUID = '71';
