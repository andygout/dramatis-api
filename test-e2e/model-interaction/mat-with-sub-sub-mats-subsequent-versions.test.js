...
describe('Material with sub-sub-materials and subsequent versions thereof', () => {
	...
	const THE_FIRST_HENRIAD_ORIGINAL_VERSION_MATERIAL_UUID = '14';
	const THE_HENRIAD_ORIGINAL_VERSION_MATERIAL_UUID = '25';
	const RICHARD_II_SUBSEQUENT_VERSION_MATERIAL_UUID = '36';
	const CARL_HEAP_PERSON_UUID = '40';
	const BEGGARS_BELIEF_THEATRE_COMPANY_UUID = '41';
	const THE_FIRST_HENRIAD_SUBSEQUENT_VERSION_MATERIAL_UUID = '50';
	const THE_HENRIAD_SUBSEQUENT_VERSION_MATERIAL_UUID = '65';
