...
describe('Award ceremonies with crediting material collections loosely connected to source material/original version (with person/company/material nominations gained via associations to sur-sur and sub-sub-materials)', () => {
	...
	const SUB_PLUGH_PART_I_ORIGINAL_VERSION_MATERIAL_UUID = '3';
	const FRANCIS_FLOB_JR_PERSON_UUID = '4';
	const SUB_CURTAIN_UP_LTD_COMPANY_UUID = '5';
	const MID_PLUGH_SECTION_I_ORIGINAL_VERSION_MATERIAL_UUID = '15';
	const FRANCIS_FLOB_PERSON_UUID = '16';
	const MID_CURTAIN_UP_LTD_COMPANY_UUID = '17';
	const SUR_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '29';
	const FRANCIS_FLOB_SR_PERSON_UUID = '30';
	const SUR_CURTAIN_UP_LTD_COMPANY_UUID = '31';
	const SUB_PLUGH_PART_I_SUBSEQUENT_VERSION_MATERIAL_UUID = '39';
	const SUB_PLUGH_PART_II_SUBSEQUENT_VERSION_MATERIAL_UUID = '45';
	const MID_PLUGH_SECTION_I_SUBSEQUENT_VERSION_MATERIAL_UUID = '55';
	const MID_PLUGH_SECTION_II_SUBSEQUENT_VERSION_MATERIAL_UUID = '63';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '73';
	const SUB_WALDO_PART_I_MATERIAL_UUID = '83';
	const JANE_ROE_JR_PERSON_UUID = '84';
	const SUB_FICTIONEERS_LTD_COMPANY_UUID = '85';
	const MID_WALDO_SECTION_I_MATERIAL_UUID = '95';
	const JANE_ROE_PERSON_UUID = '96';
	const MID_FICTIONEERS_LTD_COMPANY_UUID = '97';
	const SUR_WALDO_MATERIAL_UUID = '109';
	const JANE_ROE_SR_PERSON_UUID = '110';
	const SUR_FICTIONEERS_LTD_COMPANY_UUID = '111';
	const SUB_WIBBLE_PART_I_MATERIAL_UUID = '117';
	const SUB_WIBBLE_PART_II_MATERIAL_UUID = '121';
	const MID_WIBBLE_SECTION_I_MATERIAL_UUID = '129';
	const MID_WIBBLE_SECTION_II_MATERIAL_UUID = '135';
	const SUR_WIBBLE_MATERIAL_UUID = '143';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '152';
	const WORDSMITH_AWARD_UUID = '153';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '160';
	const PLAYWRITING_PRIZE_AWARD_UUID = '161';
	const DRAMATISTS_MEDAL_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '168';
	const DRAMATISTS_MEDAL_AWARD_UUID = '169';
	const SCRIPTING_SHIELD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '176';
	const SCRIPTING_SHIELD_AWARD_UUID = '177';
	const TRAGEDIANS_TROPHY_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '184';
	const TRAGEDIANS_TROPHY_AWARD_UUID = '185';
