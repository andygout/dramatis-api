...
describe('Award ceremonies with crediting sub-materials', () => {
	...
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '154';
	const SUB_FRED_NOËL_COWARD_PRODUCTION_UUID = '158';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '160';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '162';
	const SUB_PLUGH_OLIVIER_PRODUCTION_UUID = '166';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '170';
	const SUB_PLUGH_WYNDHAMS_PRODUCTION_UUID = '174';
	const WYNDHAMS_THEATRE_VENUE_UUID = '176';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '178';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '182';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '186';
	const SUB_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '190';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '192';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '194';
	const SUB_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '198';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '202';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '206';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '210';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '220';
	const WORDSMITH_AWARD_UUID = '221';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '232';
	const PLAYWRITING_PRIZE_AWARD_UUID = '233';
