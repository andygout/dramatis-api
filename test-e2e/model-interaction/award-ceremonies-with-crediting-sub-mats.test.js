...
describe('Award ceremonies with crediting sub-materials', () => {
	...
	const SUB_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '23';
	const FRANCIS_FLOB_PERSON_UUID = '25';
	const CURTAIN_UP_LTD_COMPANY_UUID = '26';
	const SUR_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '33';
	const SUB_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '44';
	const BEATRICE_BAR_PERSON_UUID = '48';
	const STAGECRAFT_LTD_COMPANY_UUID = '49';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '58';
	const SUB_WALDO_MATERIAL_UUID = '69';
	const JANE_ROE_PERSON_UUID = '71';
	const FICTIONEERS_LTD_COMPANY_UUID = '72';
	const SUR_WALDO_MATERIAL_UUID = '79';
	const SUB_WIBBLE_MATERIAL_UUID = '89';
	const QUINCY_QUX_PERSON_UUID = '91';
	const THEATRICALS_LTD_COMPANY_UUID = '92';
	const SUR_WIBBLE_MATERIAL_UUID = '101';
	const SUB_HOGE_MATERIAL_UUID = '113';
	const CINERIGHTS_LTD_COMPANY_UUID = '117';
	const TALYSE_TATA_PERSON_UUID = '118';
	const SUR_HOGE_MATERIAL_UUID = '127';
	const NATIONAL_THEATRE_VENUE_UUID = '137';
	const OLIVIER_THEATRE_VENUE_UUID = '138';
	const LYTTELTON_THEATRE_VENUE_UUID = '139';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '143';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '144';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '145';
	const SUB_FRED_LYTTELTON_PRODUCTION_UUID = '146';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '149';
	const SUB_FRED_NOËL_COWARD_PRODUCTION_UUID = '152';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '154';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '155';
	const SUB_PLUGH_OLIVIER_PRODUCTION_UUID = '158';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '161';
	const SUB_PLUGH_WYNDHAMS_PRODUCTION_UUID = '164';
	const WYNDHAMS_THEATRE_VENUE_UUID = '166';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '167';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '170';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '173';
	const SUB_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '176';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '178';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '179';
	const SUB_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '182';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '185';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '188';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '191';
