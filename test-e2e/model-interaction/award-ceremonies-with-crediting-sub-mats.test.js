...
describe('Award ceremonies with crediting sub-materials', () => {
	...
	const SUR_FRED_MATERIAL_UUID = '11';
	const FRANCIS_FLOB_PERSON_UUID = '19';
	const CURTAIN_UP_LTD_COMPANY_UUID = '20';
	const SUB_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '36';
	const BEATRICE_BAR_PERSON_UUID = '40';
	const STAGECRAFT_LTD_COMPANY_UUID = '41';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '50';
	const SUB_WALDO_MATERIAL_UUID = '60';
	const JANE_ROE_PERSON_UUID = '61';
	const FICTIONEERS_LTD_COMPANY_UUID = '62';
	const SUR_WALDO_MATERIAL_UUID = '68';
	const SUB_WIBBLE_MATERIAL_UUID = '76';
	const QUINCY_QUX_PERSON_UUID = '77';
	const THEATRICALS_LTD_COMPANY_UUID = '78';
	const SUR_WIBBLE_MATERIAL_UUID = '86';
	const SUB_HOGE_MATERIAL_UUID = '96';
	const CINERIGHTS_LTD_COMPANY_UUID = '99';
	const TALYSE_TATA_PERSON_UUID = '100';
	const SUR_HOGE_MATERIAL_UUID = '108';
	const NATIONAL_THEATRE_VENUE_UUID = '119';
	const OLIVIER_THEATRE_VENUE_UUID = '120';
	const LYTTELTON_THEATRE_VENUE_UUID = '121';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '127';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '128';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '129';
	const SUB_FRED_LYTTELTON_PRODUCTION_UUID = '130';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '132';
	const SUB_FRED_NOËL_COWARD_PRODUCTION_UUID = '134';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '135';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '136';
	const SUB_PLUGH_OLIVIER_PRODUCTION_UUID = '138';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '140';
	const SUB_PLUGH_WYNDHAMS_PRODUCTION_UUID = '142';
	const WYNDHAMS_THEATRE_VENUE_UUID = '143';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '144';
	const SUB_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '146';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '148';
	const SUB_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '150';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '151';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '152';
	const SUB_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '154';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '156';
	const SUB_HOGE_NOËL_COWARD_PRODUCTION_UUID = '158';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '160';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '168';
	const WORDSMITH_AWARD_UUID = '169';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '180';
	const PLAYWRITING_PRIZE_AWARD_UUID = '181';
