...
describe('Award ceremonies with crediting sub-sub-materials', () => {
	...
	const SUB_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '32';
	const FRANCIS_FLOB_PERSON_UUID = '34';
	const CURTAIN_UP_LTD_COMPANY_UUID = '35';
	const MID_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '41';
	const SUR_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '51';
	const SUB_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '62';
	const BEATRICE_BAR_PERSON_UUID = '66';
	const STAGECRAFT_LTD_COMPANY_UUID = '67';
	const MID_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '75';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '89';
	const SUB_WALDO_MATERIAL_UUID = '100';
	const JANE_ROE_PERSON_UUID = '102';
	const FICTIONEERS_LTD_COMPANY_UUID = '103';
	const MID_WALDO_MATERIAL_UUID = '109';
	const SUR_WALDO_MATERIAL_UUID = '119';
	const SUB_WIBBLE_MATERIAL_UUID = '129';
	const QUINCY_QUX_PERSON_UUID = '131';
	const THEATRICALS_LTD_COMPANY_UUID = '132';
	const MID_WIBBLE_MATERIAL_UUID = '140';
	const SUR_WIBBLE_MATERIAL_UUID = '152';
	const SUB_HOGE_MATERIAL_UUID = '164';
	const CINERIGHTS_LTD_COMPANY_UUID = '168';
