...
describe('Award ceremonies with crediting sub-sub-materials (with person/company nominations gained through associations to sur-sur and sub-sub-materials)', () => {
	...
	const JOHN_DOE_PERSON_UUID = '15';
	const MID_PLAYWRIGHTS_LTD_COMPANY_UUID = '16';
	const SUR_FRED_MATERIAL_UUID = '23';
	const JOHN_DOE_SR_PERSON_UUID = '25';
	const SUR_PLAYWRIGHTS_LTD_COMPANY_UUID = '26';
	const FRANCIS_FLOB_JR_PERSON_UUID = '34';
	const SUB_CURTAIN_UP_LTD_COMPANY_UUID = '35';
	const FRANCIS_FLOB_PERSON_UUID = '43';
	const MID_CURTAIN_UP_LTD_COMPANY_UUID = '44';
	const FRANCIS_FLOB_SR_PERSON_UUID = '53';
	const SUR_CURTAIN_UP_LTD_COMPANY_UUID = '54';
	...
	const JANE_ROE_PERSON_UUID = '111';
	const MID_FICTIONEERS_LTD_COMPANY_UUID = '112';
	const JANE_ROE_SR_PERSON_UUID = '121';
	const SUR_FICTIONEERS_LTD_COMPANY_UUID = '122';
	...
	const MID_CINERIGHTS_LTD_COMPANY_UUID = '181';
	const TALYSE_TATA_PERSON_UUID = '182';
	const SUR_HOGE_MATERIAL_UUID = '191';
	const SUR_CINERIGHTS_LTD_COMPANY_UUID = '195';
	const TALYSE_TATA_SR_PERSON_UUID = '196';
