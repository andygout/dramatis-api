...
describe('Award ceremonies with crediting sub-sub-materials (with person/company/material nominations gained via associations to sur-sur and sub-sub-materials)', () => {
	...
	const MID_FRED_SECTION_I_LYTTELTON_PRODUCTION_UUID = '318';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '322';
	const SUB_FRED_PART_I_NOËL_COWARD_PRODUCTION_UUID = '326';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '328';
	const MID_FRED_SECTION_I_NOËL_COWARD_PRODUCTION_UUID = '330';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '334';
	const SUB_PLUGH_PART_I_OLIVIER_PRODUCTION_UUID = '338';
	const MID_PLUGH_SECTION_I_OLIVIER_PRODUCTION_UUID = '342';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '346';
	const SUB_PLUGH_PART_I_WYNDHAMS_PRODUCTION_UUID = '350';
	const WYNDHAMS_THEATRE_VENUE_UUID = '352';
	const MID_PLUGH_SECTION_I_WYNDHAMS_PRODUCTION_UUID = '354';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '358';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '362';
	const MID_WIBBLE_SECTION_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '366';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '370';
	const SUB_WIBBLE_PART_I_DUKE_OF_YORKS_PRODUCTION_UUID = '374';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '376';
	const MID_WIBBLE_SECTION_I_DUKE_OF_YORKS_PRODUCTION_UUID = '378';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '382';
	const SUB_HOGE_PART_I_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '386';
	const MID_HOGE_SECTION_I_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '390';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '394';
	const SUB_HOGE_PART_I_NOËL_COWARD_PRODUCTION_UUID = '398';
	const MID_HOGE_SECTION_I_NOËL_COWARD_PRODUCTION_UUID = '402';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '406';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '416';
	const WORDSMITH_AWARD_UUID = '417';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '428';
	const PLAYWRITING_PRIZE_AWARD_UUID = '429';
	const DRAMATISTS_MEDAL_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '440';
	const DRAMATISTS_MEDAL_AWARD_UUID = '441';
	const SCRIPTING_SHIELD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '452';
	const SCRIPTING_SHIELD_AWARD_UUID = '453';
	const TRAGEDIANS_TROPHY_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '464';
	const TRAGEDIANS_TROPHY_AWARD_UUID = '465';
