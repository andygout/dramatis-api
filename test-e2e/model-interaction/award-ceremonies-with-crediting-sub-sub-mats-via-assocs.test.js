...
describe('Award ceremonies with crediting sub-sub-materials (with person/company/material nominations gained via associations to sur-sur and sub-sub-materials)', () => {
	...
	const SUB_FRED_PART_I_MATERIAL_UUID = '3';
	const JOHN_DOE_JR_PERSON_UUID = '4';
	const SUB_PLAYWRIGHTS_LTD_COMPANY_UUID = '5';
	const SUB_FRED_PART_II_MATERIAL_UUID = '7';
	const MID_FRED_SECTION_I_MATERIAL_UUID = '15';
	const JOHN_DOE_PERSON_UUID = '16';
	const MID_PLAYWRIGHTS_LTD_COMPANY_UUID = '17';
	const MID_FRED_SECTION_II_MATERIAL_UUID = '21';
	const SUR_FRED_MATERIAL_UUID = '29';
	const JOHN_DOE_SR_PERSON_UUID = '30';
	const SUR_PLAYWRIGHTS_LTD_COMPANY_UUID = '31';
	const SUB_PLUGH_PART_I_ORIGINAL_VERSION_MATERIAL_UUID = '37';
	const FRANCIS_FLOB_JR_PERSON_UUID = '38';
	const SUB_CURTAIN_UP_LTD_COMPANY_UUID = '39';
	const MID_PLUGH_SECTION_I_ORIGINAL_VERSION_MATERIAL_UUID = '49';
	const FRANCIS_FLOB_PERSON_UUID = '50';
	const MID_CURTAIN_UP_LTD_COMPANY_UUID = '51';
	const SUR_PLUGH_ORIGINAL_VERSION_MATERIAL_UUID = '63';
	const FRANCIS_FLOB_SR_PERSON_UUID = '64';
	const SUR_CURTAIN_UP_LTD_COMPANY_UUID = '65';
	const SUB_PLUGH_PART_I_SUBSEQUENT_VERSION_MATERIAL_UUID = '74';
	const SUB_PLUGH_PART_II_SUBSEQUENT_VERSION_MATERIAL_UUID = '82';
	const MID_PLUGH_SECTION_I_SUBSEQUENT_VERSION_MATERIAL_UUID = '94';
	const MID_PLUGH_SECTION_II_SUBSEQUENT_VERSION_MATERIAL_UUID = '104';
	const SUR_PLUGH_SUBSEQUENT_VERSION_MATERIAL_UUID = '116';
	const SUB_WALDO_PART_I_MATERIAL_UUID = '127';
	const JANE_ROE_JR_PERSON_UUID = '128';
	const SUB_FICTIONEERS_LTD_COMPANY_UUID = '129';
	const MID_WALDO_SECTION_I_MATERIAL_UUID = '139';
	const JANE_ROE_PERSON_UUID = '140';
	const MID_FICTIONEERS_LTD_COMPANY_UUID = '141';
	const SUR_WALDO_MATERIAL_UUID = '153';
	const JANE_ROE_SR_PERSON_UUID = '154';
	const SUR_FICTIONEERS_LTD_COMPANY_UUID = '155';
	const SUB_WIBBLE_PART_I_MATERIAL_UUID = '162';
	const SUB_WIBBLE_PART_II_MATERIAL_UUID = '168';
	const MID_WIBBLE_SECTION_I_MATERIAL_UUID = '178';
	const MID_WIBBLE_SECTION_II_MATERIAL_UUID = '186';
	const SUR_WIBBLE_MATERIAL_UUID = '196';
	const SUB_HOGE_PART_I_MATERIAL_UUID = '207';
	const SUB_CINERIGHTS_LTD_COMPANY_UUID = '210';
	const TALYSE_TATA_JR_PERSON_UUID = '211';
	const SUB_HOGE_PART_II_MATERIAL_UUID = '213';
	const MID_HOGE_SECTION_I_MATERIAL_UUID = '223';
	const MID_CINERIGHTS_LTD_COMPANY_UUID = '226';
	const TALYSE_TATA_PERSON_UUID = '227';
	const MID_HOGE_SECTION_II_MATERIAL_UUID = '231';
	const SUR_HOGE_MATERIAL_UUID = '241';
	const SUR_CINERIGHTS_LTD_COMPANY_UUID = '244';
	const TALYSE_TATA_SR_PERSON_UUID = '245';
	const NATIONAL_THEATRE_VENUE_UUID = '253';
	const OLIVIER_THEATRE_VENUE_UUID = '254';
	const LYTTELTON_THEATRE_VENUE_UUID = '255';
	const ROYAL_COURT_THEATRE_VENUE_UUID = '261';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '262';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '263';
	const SUB_FRED_PART_I_LYTTELTON_PRODUCTION_UUID = '264';
	const MID_FRED_SECTION_I_LYTTELTON_PRODUCTION_UUID = '266';
	const SUR_FRED_LYTTELTON_PRODUCTION_UUID = '268';
	const SUB_FRED_PART_I_NOËL_COWARD_PRODUCTION_UUID = '270';
	const NOËL_COWARD_THEATRE_VENUE_UUID = '271';
	const MID_FRED_SECTION_I_NOËL_COWARD_PRODUCTION_UUID = '272';
	const SUR_FRED_NOËL_COWARD_PRODUCTION_UUID = '274';
	const SUB_PLUGH_PART_I_OLIVIER_PRODUCTION_UUID = '276';
	const MID_PLUGH_SECTION_I_OLIVIER_PRODUCTION_UUID = '278';
	const SUR_PLUGH_OLIVIER_PRODUCTION_UUID = '280';
	const SUB_PLUGH_PART_I_WYNDHAMS_PRODUCTION_UUID = '282';
	const WYNDHAMS_THEATRE_VENUE_UUID = '283';
	const MID_PLUGH_SECTION_I_WYNDHAMS_PRODUCTION_UUID = '284';
	const SUR_PLUGH_WYNDHAMS_PRODUCTION_UUID = '286';
	const SUB_WIBBLE_PART_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '288';
	const MID_WIBBLE_SECTION_I_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '290';
	const SUR_WIBBLE_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '292';
	const SUB_WIBBLE_PART_I_DUKE_OF_YORKS_PRODUCTION_UUID = '294';
	const DUKE_OF_YORKS_THEATRE_VENUE_UUID = '295';
	const MID_WIBBLE_SECTION_I_DUKE_OF_YORKS_PRODUCTION_UUID = '296';
	const SUR_WIBBLE_DUKE_OF_YORKS_PRODUCTION_UUID = '298';
	const SUB_HOGE_PART_I_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '300';
	const MID_HOGE_SECTION_I_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '302';
	const SUR_HOGE_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '304';
	const SUB_HOGE_PART_I_NOËL_COWARD_PRODUCTION_UUID = '306';
	const MID_HOGE_SECTION_I_NOËL_COWARD_PRODUCTION_UUID = '308';
	const SUR_HOGE_NOËL_COWARD_PRODUCTION_UUID = '310';
	const WORDSMITH_AWARD_TWO_THOUSAND_AND_TEN_AWARD_CEREMONY_UUID = '318';
	const WORDSMITH_AWARD_UUID = '319';
	const PLAYWRITING_PRIZE_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '330';
	const PLAYWRITING_PRIZE_AWARD_UUID = '331';
	const DRAMATISTS_MEDAL_TWO_THOUSAND_AND_EIGHT_AWARD_CEREMONY_UUID = '342';
	const DRAMATISTS_MEDAL_AWARD_UUID = '343';
	const SCRIPTING_SHIELD_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '354';
	const SCRIPTING_SHIELD_AWARD_UUID = '355';
	const TRAGEDIANS_TROPHY_TWO_THOUSAND_AND_NINE_AWARD_CEREMONY_UUID = '366';
	const TRAGEDIANS_TROPHY_AWARD_UUID = '367';
