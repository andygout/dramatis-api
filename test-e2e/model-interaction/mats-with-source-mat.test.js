...
describe('Materials with source material', () => {
	...
	const WILLIAM_SHAKESPEARE_PERSON_UUID = '9';
	const THE_KINGS_MEN_COMPANY_UUID = '10';
	const THE_DONKEY_SHOW_MATERIAL_UUID = '15';
	const DIANE_PAULUS_PERSON_UUID = '16';
	const RANDY_WEINER_PERSON_UUID = '17';
	const THE_INDIAN_BOY_MATERIAL_UUID = '24';
	const RONA_MUNRO_PERSON_UUID = '25';
	const ROYAL_SHAKESPEARE_COMPANY_UUID = '26';
	const THE_INDIAN_BOY_CHARACTER_UUID = '28';
	const SHAKESPEARES_VILLAINS_MATERIAL_UUID = '35';
	const STEVEN_BERKOFF_PERSON_UUID = '36';
	const EAST_PRODUCTIONS_COMPANY_UUID = '37';
	const IAGO_CHARACTER_UUID = '40';
	const A_MOORISH_CAPTAIN_MATERIAL_UUID = '44';
	const OTHELLO_MATERIAL_UUID = '52';
	const A_MIDSUMMER_NIGHTS_DREAM_NOVELLO_THEATRE_PRODUCTION_UUID = '57';
	const NOVELLO_THEATRE_VENUE_UUID = '59';
	const THE_DONKEY_SHOW_HANOVER_GRAND_PRODUCTION_UUID = '60';
	const HANOVER_GRAND_VENUE_UUID = '62';
	const THE_INDIAN_BOY_ROYAL_SHAKESPEARE_THEATRE_PRODUCTION_UUID = '63';
	const SHAKESPEARES_VILLAINS_THEATRE_ROYAL_HAYMARKET_PRODUCTION_UUID = '66';
	const OTHELLO_DONMAR_WAREHOUSE_PRODUCTION_UUID = '69';
	const DONMAR_WAREHOUSE_VENUE_UUID = '71';
