...
describe('Productions with producers', () => {
	...
	const ROYAL_COURT_THEATRE_VENUE_UUID = '7';
	const JERWOOD_THEATRE_DOWNSTAIRS_VENUE_UUID = '8';
	const JERWOOD_THEATRE_UPSTAIRS_VENUE_UUID = '9';
	const THE_SITE_VENUE_UUID = '10';
	const HANGMEN_WYNDHAMS_PRODUCTION_UUID = '11';
	const WYNDHAMS_THEATRE_VENUE_UUID = '13';
	const ROBERT_FOX_PERSON_UUID = '15';
	const SONIA_FRIEDMAN_PRODUCTIONS_COMPANY_UUID = '16';
	const ROYAL_COURT_THEATRE_COMPANY_UUID = '17';
	const VICKY_FEATHERSTONE_PERSON_UUID = '18';
	const LUCY_DAVIES_PERSON_UUID = '19';
	const OLA_INCE_PERSON_UUID = '20';
	const PAUL_ELLIOTT_PERSON_UUID = '21';
	const OLD_VIC_PRODUCTIONS_COMPANY_UUID = '22';
	const PLAYFUL_PRODUCTIONS_COMPANY_UUID = '23';
	const MATTHEW_BYAM_SHAW_PERSON_UUID = '24';
	const NIA_JANIS_PERSON_UUID = '25';
	const NICK_SALMON_PERSON_UUID = '26';
	const ERIC_ABRAHAM_PERSON_UUID = '27';
	const WHITE_PEARL_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '28';
	const HAMISH_PIRIE_PERSON_UUID = '39';
	const HARRIET_ASTBURY_PERSON_UUID = '43';
	const PAH_LA_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '45';
	const SAM_PRITCHARD_PERSON_UUID = '55';
	const ROGER_CHAPMAN_PERSON_UUID = '58';
	const LIGHTS_OUT_THE_SITE_PRODUCTION_UUID = '62';
