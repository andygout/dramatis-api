...
describe('Productions with producers', () => {
	...
	const WYNDHAMS_THEATRE_VENUE_UUID = '12';
	const ROBERT_FOX_PERSON_UUID = '13';
	const SONIA_FRIEDMAN_PRODUCTIONS_COMPANY_UUID = '14';
	const ROYAL_COURT_THEATRE_COMPANY_UUID = '15';
	const VICKY_FEATHERSTONE_PERSON_UUID = '16';
	const LUCY_DAVIES_PERSON_UUID = '17';
	const OLA_INCE_PERSON_UUID = '18';
	const PAUL_ELLIOTT_PERSON_UUID = '19';
	const OLD_VIC_PRODUCTIONS_COMPANY_UUID = '20';
	const PLAYFUL_PRODUCTIONS_COMPANY_UUID = '21';
	const MATTHEW_BYAM_SHAW_PERSON_UUID = '22';
	const NIA_JANIS_PERSON_UUID = '23';
	const NICK_SALMON_PERSON_UUID = '24';
	const ERIC_ABRAHAM_PERSON_UUID = '25';
	const WHITE_PEARL_JERWOOD_THEATRE_DOWNSTAIRS_PRODUCTION_UUID = '26';
	const HAMISH_PIRIE_PERSON_UUID = '35';
	const HARRIET_ASTBURY_PERSON_UUID = '39';
	const PAH_LA_JERWOOD_THEATRE_UPSTAIRS_PRODUCTION_UUID = '41';
