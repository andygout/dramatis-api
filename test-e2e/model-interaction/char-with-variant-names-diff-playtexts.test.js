...
describe('Character with variant names from productions of different playtexts', () => {
	...
	const HAMLET_PLAYTEXT_UUID = '4';
	const HAMLET_CHARACTER_UUID = '6';
	const CLAUDIUS_CHARACTER_UUID = '7';
	const ROSENCRANTZ_AND_GUILDENSTERN_ARE_DEAD_PLAYTEXT_UUID = '12';
	const FORTINBRAS_PLAYTEXT_UUID = '20';
	const HAMLETMACHINE_PLAYTEXT_UUID = '28';
