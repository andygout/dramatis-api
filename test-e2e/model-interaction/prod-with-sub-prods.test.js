...
describe('Production with sub-productions', () => {
	...
	const THE_COAST_OF_UTOPIA_MATERIAL_UUID = '45';
	const TOM_STOPPARD_SR_PERSON_UUID = '47';
	const THE_SUR_STRÄUSSLER_GROUP_COMPANY_UUID = '48';
	const ALEXANDER_HERZEN_SR_CHARACTER_UUID = '52';
	const VOYAGE_OLIVIER_PRODUCTION_UUID = '53';
	const TREVOR_NUNN_JR_PERSON_UUID = '56';
	const SUB_NATIONAL_THEATRE_COMPANY_UUID = '57';
	const NICK_STARR_JR_PERSON_UUID = '58';
	const STEPHEN_DILLANE_JR_PERSON_UUID = '59';
	const STEVEN_EDIS_JR_PERSON_UUID = '60';
	const SUB_MUSICAL_DIRECTION_LTD_COMPANY_UUID = '61';
	const MARK_BOUSIE_JR_PERSON_UUID = '62';
	const FIONA_BARDSLEY_JR_PERSON_UUID = '63';
	const SUB_STAGE_MANAGEMENT_LTD_COMPANY_UUID = '64';
	const SUE_MILLIN_JR_PERSON_UUID = '65';
	const SHIPWRECK_OLIVIER_PRODUCTION_UUID = '66';
	const SALVAGE_OLIVIER_PRODUCTION_UUID = '79';
	const THE_COAST_OF_UTOPIA_OLIVIER_PRODUCTION_UUID = '92';
	const TREVOR_NUNN_SR_PERSON_UUID = '95';
	const SUR_NATIONAL_THEATRE_COMPANY_UUID = '96';
	const NICK_STARR_SR_PERSON_UUID = '97';
	const STEPHEN_DILLANE_SR_PERSON_UUID = '98';
	const STEVEN_EDIS_SR_PERSON_UUID = '99';
	const SUR_MUSICAL_DIRECTION_LTD_COMPANY_UUID = '100';
	const MARK_BOUSIE_SR_PERSON_UUID = '101';
	const FIONA_BARDSLEY_SR_PERSON_UUID = '102';
	const SUR_STAGE_MANAGEMENT_LTD_COMPANY_UUID = '103';
	const SUE_MILLIN_SR_PERSON_UUID = '104';
	const VOYAGE_VIVIAN_BEAUMONT_PRODUCTION_UUID = '105';
	const VIVIAN_BEAUMONT_THEATRE_VENUE_UUID = '107';
	const SHIPWRECK_VIVIAN_BEAUMONT_PRODUCTION_UUID = '108';
	const SALVAGE_VIVIAN_BEAUMONT_PRODUCTION_UUID = '111';
	const THE_COAST_OF_UTOPIA_VIVIAN_BEAUMONT_PRODUCTION_UUID = '114';
