...
describe('Production with sub-productions', () => {
	...
	const TOM_STOPPARD_JR_PERSON_UUID = '10';
	const THE_SUB_STRÄUSSLER_GROUP_COMPANY_UUID = '11';
	const ALEXANDER_HERZEN_JR_CHARACTER_UUID = '12';
	const SHIPWRECK_MATERIAL_UUID = '17';
	const SALVAGE_MATERIAL_UUID = '25';
	const THE_COAST_OF_UTOPIA_MATERIAL_UUID = '39';
	const TOM_STOPPARD_SR_PERSON_UUID = '40';
	const THE_SUR_STRÄUSSLER_GROUP_COMPANY_UUID = '41';
	const ALEXANDER_HERZEN_SR_CHARACTER_UUID = '45';
	const VOYAGE_OLIVIER_PRODUCTION_UUID = '46';
	const STOPPARD_SEASON_UUID = '49';
	const TREVOR_NUNN_JR_PERSON_UUID = '50';
	const SUB_NATIONAL_THEATRE_COMPANY_UUID = '51';
	const NICK_STARR_JR_PERSON_UUID = '52';
	const STEPHEN_DILLANE_JR_PERSON_UUID = '53';
	const STEVEN_EDIS_JR_PERSON_UUID = '54';
	const SUB_MUSICAL_DIRECTION_LTD_COMPANY_UUID = '55';
	const MARK_BOUSIE_JR_PERSON_UUID = '56';
	const FIONA_BARDSLEY_JR_PERSON_UUID = '57';
	const SUB_STAGE_MANAGEMENT_LTD_COMPANY_UUID = '58';
	const SUE_MILLIN_JR_PERSON_UUID = '59';
	const SHIPWRECK_OLIVIER_PRODUCTION_UUID = '60';
	const SALVAGE_OLIVIER_PRODUCTION_UUID = '74';
	const THE_COAST_OF_UTOPIA_OLIVIER_PRODUCTION_UUID = '88';
