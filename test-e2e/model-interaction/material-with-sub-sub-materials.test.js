...
describe('Material with sub-sub-materials', () => {
	...
	const BLACK_TULIPS_MATERIAL_UUID = '35';
	const DAVID_EDGAR_PERSON_UUID = '37';
	const BLOOD_AND_GIFTS_MATERIAL_UUID = '41';
	const J_T_ROGERS_PERSON_UUID = '43';
	const MINISKIRTS_OF_KABUL_MATERIAL_UUID = '49';
	const PART_TWO_COMMUNISM_THE_MUJAHIDEEN_AND_THE_TALIBAN_MATERIAL_UUID = '59';
