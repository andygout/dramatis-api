...
describe('Productions with creative team', () => {
	...
	const DEBORAH_WARNER_PERSON_UUID = '14';
	const AUTOGRAPH_COMPANY_UUID = '15';
	const MESMER_COMPANY_UUID = '16';
	const DICK_STRAKER_PERSON_UUID = '17';
	const IAN_WILLIAM_GALLOWAY_PERSON_UUID = '18';
	const JOHN_O_CONNELL_PERSON_UUID = '19';
	const AKHILA_KIRSHNAN_PERSON_UUID = '20';
	const CINELUMA_COMPANY_UUID = '21';
	const FIFTY_NINE_PRODUCTIONS_COMPANY_UUID = '22';
	const LEO_WARNER_PERSON_UUID = '23';
	const MARK_GRIMMER_PERSON_UUID = '24';
	const LYSANDER_ASHTON_PERSON_UUID = '25';
	const NINA_DUNN_PERSON_UUID = '26';
	const MOTHER_COURAGE_AND_HER_CHILDREN_OLIVIER_PRODUCTION_UUID = '27';
	const DANIEL_DENTON_PERSON_UUID = '36';
	const ANNA_JAMESON_PERSON_UUID = '39';
	const HAPPY_DAYS_LYTTELTON_PRODUCTION_UUID = '43';
	const BARBORA_ŠENOLTOVÁ_PERSON_UUID = '53';
	const RICHARD_SLANEY_PERSON_UUID = '57';
	const RICHARD_II_COTTESLOE_PRODUCTION_UUID = '59';
