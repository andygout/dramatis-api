...
describe('Productions with creative team', () => {
	...
	const DEBORAH_WARNER_PERSON_UUID = '15';
	const AUTOGRAPH_COMPANY_UUID = '16';
	const MESMER_COMPANY_UUID = '17';
	const DICK_STRAKER_PERSON_UUID = '18';
	const IAN_WILLIAM_GALLOWAY_PERSON_UUID = '19';
	const JOHN_O_CONNELL_PERSON_UUID = '20';
	const AKHILA_KIRSHNAN_PERSON_UUID = '21';
	const CINELUMA_COMPANY_UUID = '22';
	const FIFTY_NINE_PRODUCTIONS_COMPANY_UUID = '23';
	const LEO_WARNER_PERSON_UUID = '24';
	const MARK_GRIMMER_PERSON_UUID = '25';
	const LYSANDER_ASHTON_PERSON_UUID = '26';
	const NINA_DUNN_PERSON_UUID = '27';
	const MOTHER_COURAGE_AND_HER_CHILDREN_OLIVIER_PRODUCTION_UUID = '28';
	const DANIEL_DENTON_PERSON_UUID = '38';
	const ANNA_JAMESON_PERSON_UUID = '41';
	const HAPPY_DAYS_LYTTELTON_PRODUCTION_UUID = '45';
	const BARBORA_ŠENOLTOVÁ_PERSON_UUID = '56';
	const RICHARD_SLANEY_PERSON_UUID = '60';
	const RICHARD_II_COTTESLOE_PRODUCTION_UUID = '62';
