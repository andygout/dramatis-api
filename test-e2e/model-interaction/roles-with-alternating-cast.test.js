...
describe('Roles with alternating cast', () => {
	...
	const NIGEL_HARMAN_PERSON_UUID = '12';
	const JOHN_LIGHT_PERSON_UUID = '13';
	const TRUE_WEST_VAUDEVILLE_PRODUCTION_UUID = '14';
	const VAUDEVILLE_THEATRE_VENUE_UUID = '16';
	const KIT_HARINGTON_PERSON_UUID = '18';
	const JOHNNY_FLYNN_PERSON_UUID = '19';
