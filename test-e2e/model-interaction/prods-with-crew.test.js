...
describe('Productions with crew', () => {
	...
	const TARIQ_HUSSAIN_PERSON_UUID = '15';
	const STAGECRAFT_LTD_COMPANY_UUID = '16';
	const CREW_DEPUTIES_LTD_COMPANY_UUID = '17';
	const BENJAMIN_DONOGHUE_PERSON_UUID = '18';
	const NIK_HAFFENDEN_PERSON_UUID = '19';
	const EMMA_CAMERON_PERSON_UUID = '20';
	const PRAD_PANKHANI_PERSON_UUID = '21';
	const THEATRICAL_PRODUCTION_SERVICES_LTD_COMPANY_UUID = '22';
	const CREW_ASSISTANTS_LTD_COMPANY_UUID = '23';
	const SARA_GUNTER_PERSON_UUID = '24';
	const JULIA_WICKHAM_PERSON_UUID = '25';
	const CHERYL_FIRTH_PERSON_UUID = '26';
	const CASS_KIRCHNER_PERSON_UUID = '27';
	const MUCH_ADO_ABOUT_NOTHING_OLIVIER_PRODUCTION_UUID = '28';
	const TAMARA_ALBACHARI_PERSON_UUID = '38';
	const PETER_GREGORY_PERSON_UUID = '41';
	const PHÈDRE_LYTTELTON_PRODUCTION_UUID = '45';
	const KERRY_MCDEVITT_PERSON_UUID = '56';
	const TOM_LEGGAT_PERSON_UUID = '60';
	const PAINS_OF_YOUTH_COTTESLOE_PRODUCTION_UUID = '62';
