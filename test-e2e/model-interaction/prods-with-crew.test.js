...
describe('Productions with crew', () => {
	...
	const TARIQ_HUSSAIN_PERSON_UUID = '13';
	const STAGECRAFT_LTD_COMPANY_UUID = '14';
	const CREW_DEPUTIES_LTD_COMPANY_UUID = '15';
	const BENJAMIN_DONOGHUE_PERSON_UUID = '16';
	const NIK_HAFFENDEN_PERSON_UUID = '17';
	const EMMA_CAMERON_PERSON_UUID = '18';
	const PRAD_PANKHANI_PERSON_UUID = '19';
	const THEATRICAL_PRODUCTION_SERVICES_LTD_COMPANY_UUID = '20';
	const CREW_ASSISTANTS_LTD_COMPANY_UUID = '21';
	const SARA_GUNTER_PERSON_UUID = '22';
	const JULIA_WICKHAM_PERSON_UUID = '23';
	const CHERYL_FIRTH_PERSON_UUID = '24';
	const CASS_KIRCHNER_PERSON_UUID = '25';
	const MUCH_ADO_ABOUT_NOTHING_OLIVIER_PRODUCTION_UUID = '26';
	const TAMARA_ALBACHARI_PERSON_UUID = '34';
	const PETER_GREGORY_PERSON_UUID = '37';
	const PHÈDRE_LYTTELTON_PRODUCTION_UUID = '41';
