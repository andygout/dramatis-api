...
describe('Character in multiple productions of multiple materials', () => {
	...
	const MICHAEL_GAMBON_PERSON_UUID = '22';
	const HENRY_IV_PART_2_NATIONAL_PRODUCTION_UUID = '23';
	const THE_MERRY_WIVES_OF_WINDSOR_NATIONAL_PRODUCTION_UUID = '28';
	const HENRY_IV_PART_1_GLOBE_PRODUCTION_UUID = '33';
	const SHAKESPEARES_GLOBE_VENUE_UUID = '35';
	const ROGER_ALLAM_PERSON_UUID = '37';
	const HENRY_IV_PART_2_GLOBE_PRODUCTION_UUID = '38';
	const THE_MERRY_WIVES_OF_WINDSOR_GLOBE_PRODUCTION_UUID = '43';
	const HENRY_IV_PART_1_SWAN_PRODUCTION_UUID = '48';
	const SWAN_THEATRE_VENUE_UUID = '50';
	const RICHARD_CORDERY_PERSON_UUID = '52';
	const HENRY_IV_PART_2_SWAN_PRODUCTION_UUID = '53';
	const THE_MERRY_WIVES_OF_WINDSOR_SWAN_PRODUCTION_UUID = '58';
