...
const HENRY_IV_PART_1_GLOBE_PRODUCTION_UUID = 'HENRY_IV_PART_1_PRODUCTION_2_UUID';
const SHAKESPEARES_GLOBE_VENUE_UUID = 'SHAKESPEARES_GLOBE_VENUE_UUID';
const ROGER_ALLAM_PERSON_UUID = 'ROGER_ALLAM_PERSON_UUID';
const HENRY_IV_PART_2_GLOBE_PRODUCTION_UUID = 'HENRY_IV_PART_2_PRODUCTION_2_UUID';
const THE_MERRY_WIVES_OF_WINDSOR_GLOBE_PRODUCTION_UUID = 'THE_MERRY_WIVES_OF_WINDSOR_PRODUCTION_2_UUID';
const HENRY_IV_PART_1_SWAN_PRODUCTION_UUID = 'HENRY_IV_PART_1_PRODUCTION_3_UUID';
const SWAN_THEATRE_VENUE_UUID = 'SWAN_THEATRE_VENUE_UUID';
const RICHARD_CORDERY_PERSON_UUID = 'RICHARD_CORDERY_PERSON_UUID';
const HENRY_IV_PART_2_SWAN_PRODUCTION_UUID = 'HENRY_IV_PART_2_PRODUCTION_3_UUID';
const THE_MERRY_WIVES_OF_WINDSOR_SWAN_PRODUCTION_UUID = 'THE_MERRY_WIVES_OF_WINDSOR_PRODUCTION_3_UUID';
