...
describe('Character with multiple appearances in the same material under different qualifiers', () => {
	...
	const ALICE_EVE_PERSON_UUID = '16';
	const BRIAN_COX_PERSON_UUID = '17';
	const SINEAD_CUSACK_PERSON_UUID = '18';
	const HANDBAGGED_MATERIAL_UUID = '24';
	const MARGARET_THATCHER_CHARACTER_UUID = '26';
	const QUEEN_ELIZABETH_II_CHARACTER_UUID = '27';
	const RONALD_REAGAN_CHARACTER_UUID = '28';
	const HANDBAGGED_TRICYCLE_PRODUCTION_UUID = '29';
	const TRICYCLE_THEATRE_VENUE_UUID = '31';
	const STELLA_GONET_PERSON_UUID = '33';
	const KIKA_MARKHAM_PERSON_UUID = '34';
	const HEATHER_CRANEY_PERSON_UUID = '35';
	const CLAIRE_COX_PERSON_UUID = '36';
	const TOM_MANNION_PERSON_UUID = '37';
