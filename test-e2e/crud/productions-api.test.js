...
describe('CRUD (Create, Read, Update, Delete): Productions API', () => {
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const THE_TRAGEDY_OF_HAMLET_MATERIAL_UUID = 'THE_TRAGEDY_OF_HAMLET_MATERIAL_1_UUID';
		const NATIONAL_THEATRE_VENUE_UUID = 'NATIONAL_THEATRE_VENUE_1_UUID';
		const SHAKESPEAREAN_TRAGEDY_SEASON_UUID = 'SHAKESPEAREAN_TRAGEDY_SEASON_SEASON_1_UUID';
		const THE_COMPLETE_WORKS_FESTIVAL_UUID = 'THE_COMPLETE_WORKS_FESTIVAL_1_UUID';
		const LISA_BURGER_PERSON_UUID = 'LISA_BURGER_PERSON_1_UUID';
		const FUEL_THEATRE_COMPANY_UUID = 'FUEL_THEATRE_COMPANY_1_UUID';
		const SIMON_GODWIN_PERSON_UUID = 'SIMON_GODWIN_PERSON_1_UUID';
		const TOM_MORRIS_PERSON_UUID = 'TOM_MORRIS_PERSON_1_UUID';
		const NATIONAL_THEATRE_COMPANY_UUID = 'NATIONAL_THEATRE_COMPANY_COMPANY_1_UUID';
		const NICHOLAS_HYTNER_PERSON_UUID = 'NICHOLAS_HYTNER_PERSON_1_UUID';
		const NICK_STARR_PERSON_UUID = 'NICK_STARR_PERSON_1_UUID';
		const LONDON_THEATRE_COMPANY_UUID = 'LONDON_THEATRE_COMPANY_COMPANY_1_UUID';
		const RORY_KINNEAR_PERSON_UUID = 'RORY_KINNEAR_PERSON_1_UUID';
		const JAMES_LAURENSON_PERSON_UUID = 'JAMES_LAURENSON_PERSON_1_UUID';
		const MICHAEL_SHELDON_PERSON_UUID = 'MICHAEL_SHELDON_PERSON_1_UUID';
		const LEO_STAAR_PERSON_UUID = 'LEO_STAAR_PERSON_1_UUID';
		const HANDSPRING_PUPPET_COMPANY_UUID = 'HANDSPRING_PUPPET_COMPANY_COMPANY_1_UUID';
		const BEN_RINGHAM_PERSON_UUID = 'BEN_RINGHAM_PERSON_1_UUID';
		const MAX_RINGHAM_PERSON_UUID = 'MAX_RINGHAM_PERSON_1_UUID';
		const FIFTY_NINE_PRODUCTIONS_COMPANY_UUID = '59_PRODUCTIONS_COMPANY_1_UUID';
		const LEO_WARNER_PERSON_UUID = 'LEO_WARNER_PERSON_1_UUID';
		const MARK_GRIMMER_PERSON_UUID = 'MARK_GRIMMER_PERSON_1_UUID';
		const IGOR_PERSON_UUID = 'IGOR_PERSON_1_UUID';
		const CREW_DEPUTIES_LTD_COMPANY_UUID = 'CREW_DEPUTIES_LTD_COMPANY_1_UUID';
		const SARA_GUNTER_PERSON_UUID = 'SARA_GUNTER_PERSON_1_UUID';
		const JULIA_WICKHAM_PERSON_UUID = 'JULIA_WICKHAM_PERSON_1_UUID';
		const CREW_ASSISTANTS_LTD_COMPANY_UUID = 'CREW_ASSISTANTS_LTD_COMPANY_1_UUID';
		const MOLLY_EINCHCOMB_PERSON_UUID = 'MOLLY_EINCHCOMB_PERSON_1_UUID';
		const MATTHEW_HELLYER_PERSON_UUID = 'MATTHEW_HELLYER_PERSON_1_UUID';
		const FINANCIAL_TIMES_COMPANY_UUID = 'FINANCIAL_TIMES_COMPANY_1_UUID';
		const IAN_SHUTTLEWORTH_PERSON_UUID = 'IAN_SHUTTLEWORTH_PERSON_1_UUID';
		const THE_GUARDIAN_COMPANY_UUID = 'THE_GUARDIAN_COMPANY_1_UUID';
		const MICHAEL_BILLINGTON_PERSON_UUID = 'MICHAEL_BILLINGTON_PERSON_1_UUID';
		const THE_TELEGRAPH_COMPANY_UUID = 'THE_TELEGRAPH_COMPANY_1_UUID';
		const CHARLES_SPENCER_PERSON_UUID = 'CHARLES_SPENCER_PERSON_1_UUID';
		const THE_TRAGEDY_OF_KING_RICHARD_III_MATERIAL_UUID = 'THE_TRAGEDY_OF_KING_RICHARD_III_MATERIAL_1_UUID';
		const ALMEIDA_THEATRE_VENUE_UUID = 'ALMEIDA_THEATRE_VENUE_1_UUID';
		const SHAKESPEAREAN_HISTORY_SEASON_UUID = 'SHAKESPEAREAN_HISTORY_SEASON_SEASON_1_UUID';
		const GLOBE_TO_GLOBE_FESTIVAL_UUID = 'GLOBE_TO_GLOBE_FESTIVAL_1_UUID';
		const DENISE_WOOD_PERSON_UUID = 'DENISE_WOOD_PERSON_1_UUID';
		const TIATA_FAHODZI_COMPANY_UUID = 'TIATA_FAHODZI_COMPANY_1_UUID';
		const REBECCA_FRECKNALL_PERSON_UUID = 'REBECCA_FRECKNALL_PERSON_1_UUID';
		const SIMEON_BLAKE_HALL_PERSON_UUID = 'SIMEON_BLAKE_HALL_PERSON_1_UUID';
		const ALMEIDA_THEATRE_COMPANY_UUID = 'ALMEIDA_THEATRE_COMPANY_COMPANY_1_UUID';
		const RUPERT_GOOLD_PERSON_UUID = 'RUPERT_GOOLD_PERSON_1_UUID';
		const ROBERT_ICKE_PERSON_UUID = 'ROBERT_ICKE_PERSON_1_UUID';
		const HEADLONG_THEATRE_COMPANY_UUID = 'HEADLONG_THEATRE_COMPANY_1_UUID';
		const RALPH_FIENNES_PERSON_UUID = 'RALPH_FIENNES_PERSON_1_UUID';
		const TOM_CANTON_PERSON_UUID = 'TOM_CANTON_PERSON_1_UUID';
		const MARK_HADFIELD_PERSON_UUID = 'MARK_HADFIELD_PERSON_1_UUID';
		const JOSH_COLLINS_PERSON_UUID = 'JOSH_COLLINS_PERSON_1_UUID';
		const RC_ANNIE_COMPANY_UUID = 'RC_ANNIE_COMPANY_1_UUID';
		const HILDEGARD_BECHTLER_PERSON_UUID = 'HILDEGARD_BECHTLER_PERSON_1_UUID';
		const CHLOE_LAMFORD_PERSON_UUID = 'CHLOE_LAMFORD_PERSON_1_UUID';
		const AUTOGRAPH_COMPANY_UUID = 'AUTOGRAPH_COMPANY_1_UUID';
		const ANDREW_BRUCE_PERSON_UUID = 'ANDREW_BRUCE_PERSON_1_UUID';
		const NICK_LIDSTER_PERSON_UUID = 'NICK_LIDSTER_PERSON_1_UUID';
		const ANNA_ANDERSON_PERSON_UUID = 'ANNA_ANDERSON_PERSON_1_UUID';
		const DEPUTY_STAGE_MANAGERS_LTD_COMPANY_UUID = 'DEPUTY_STAGE_MANAGERS_LTD_COMPANY_1_UUID';
		const CHERYL_FIRTH_PERSON_UUID = 'CHERYL_FIRTH_PERSON_1_UUID';
		const TOM_LEGGAT_PERSON_UUID = 'TOM_LEGGAT_PERSON_1_UUID';
		const DESIGN_ASSISTANTS_LTD_COMPANY_UUID = 'DESIGN_ASSISTANTS_LTD_COMPANY_1_UUID';
		const COLIN_FALCONER_PERSON_UUID = 'COLIN_FALCONER_PERSON_1_UUID';
		const ALEX_LOWDE_PERSON_UUID = 'ALEX_LOWDE_PERSON_1_UUID';
		const SARAH_HEMMING_PERSON_UUID = 'SARAH_HEMMING_PERSON_1_UUID';
		const DOMINIC_CAVENDISH_PERSON_UUID = 'DOMINIC_CAVENDISH_PERSON_1_UUID';
