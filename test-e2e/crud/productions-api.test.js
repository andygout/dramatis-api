...
describe('CRUD (Create, Read, Update, Delete): Productions API', () => {
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const HAMLET_SUB_PRODUCTION_2_PRODUCTION_UUID = '1';
		const HAMLET_SUB_PRODUCTION_3_PRODUCTION_UUID = '2';
		const RICHARD_III_SUB_PRODUCTION_1_PRODUCTION_UUID = '3';
		const RICHARD_III_SUB_PRODUCTION_2_PRODUCTION_UUID = '4';
		const RICHARD_III_SUB_PRODUCTION_3_PRODUCTION_UUID = '5';
		const PRODUCTION_UUID = '6';
		const THE_TRAGEDY_OF_HAMLET_PRINCE_OF_DENMARK_MATERIAL_UUID = '7';
		const NATIONAL_THEATRE_VENUE_UUID = '8';
		const SHAKESPEAREAN_TRAGEDY_SEASON_UUID = '9';
		const LISA_BURGER_PERSON_UUID = '10';
		const FUEL_THEATRE_COMPANY_UUID = '11';
		const SIMON_GODWIN_PERSON_UUID = '12';
		const TOM_MORRIS_PERSON_UUID = '13';
		const NATIONAL_THEATRE_COMPANY_UUID = '14';
		const NICHOLAS_HYTNER_PERSON_UUID = '15';
		const NICK_STARR_PERSON_UUID = '16';
		const LONDON_THEATRE_COMPANY_UUID = '17';
		const RORY_KINNEAR_PERSON_UUID = '18';
		const JAMES_LAURENSON_PERSON_UUID = '19';
		const MICHAEL_SHELDON_PERSON_UUID = '20';
		const LEO_STAAR_PERSON_UUID = '21';
		const HANDSPRING_PUPPET_COMPANY_UUID = '22';
		const BEN_RINGHAM_PERSON_UUID = '23';
		const MAX_RINGHAM_PERSON_UUID = '24';
		const FIFTY_NINE_PRODUCTIONS_COMPANY_UUID = '25';
		const LEO_WARNER_PERSON_UUID = '26';
		const MARK_GRIMMER_PERSON_UUID = '27';
		const IGOR_PERSON_UUID = '28';
		const CREW_DEPUTIES_LTD_COMPANY_UUID = '29';
		const SARA_GUNTER_PERSON_UUID = '30';
		const JULIA_WICKHAM_PERSON_UUID = '31';
		const CREW_ASSISTANTS_LTD_COMPANY_UUID = '32';
		const MOLLY_EINCHCOMB_PERSON_UUID = '33';
		const MATTHEW_HELLYER_PERSON_UUID = '34';
		const THE_TRAGEDY_OF_KING_RICHARD_III_MATERIAL_UUID = '63';
		const ALMEIDA_THEATRE_VENUE_UUID = '64';
		const SHAKESPEAREAN_HISTORY_SEASON_UUID = '65';
		const DENISE_WOOD_PERSON_UUID = '66';
		const TIATA_FAHODZI_COMPANY_UUID = '67';
		const REBECCA_FRECKNALL_PERSON_UUID = '68';
		const SIMEON_BLAKE_HALL_PERSON_UUID = '69';
		const ALMEIDA_THEATRE_COMPANY_UUID = '70';
		const RUPERT_GOOLD_PERSON_UUID = '71';
		const ROBERT_ICKE_PERSON_UUID = '72';
		const HEADLONG_THEATRE_COMPANY_UUID = '73';
		const RALPH_FIENNES_PERSON_UUID = '74';
		const TOM_CANTON_PERSON_UUID = '75';
		const MARK_HADFIELD_PERSON_UUID = '76';
		const JOSH_COLLINS_PERSON_UUID = '77';
		const RC_ANNIE_LTD_COMPANY_UUID = '78';
		const HILDEGARD_BECHTLER_PERSON_UUID = '79';
		const CHLOE_LAMFORD_PERSON_UUID = '80';
		const AUTOGRAPH_COMPANY_UUID = '81';
		const ANDREW_BRUCE_PERSON_UUID = '82';
		const NICK_LIDSTER_PERSON_UUID = '83';
		const ANNA_ANDERSON_PERSON_UUID = '84';
		const DEPUTY_STAGE_MANAGERS_LTD_COMPANY_UUID = '85';
		const CHERYL_FIRTH_PERSON_UUID = '86';
		const TOM_LEGGAT_PERSON_UUID = '87';
		const DESIGN_ASSISTANTS_LTD_COMPANY_UUID = '88';
		const COLIN_FALCONER_PERSON_UUID = '89';
		const ALEX_LOWDE_PERSON_UUID = '90';
	...
	describe('GET list endpoint', () => {
		...
		const GIELGUD_THEATRE_VENUE_UUID = '1';
		const HAMLET_NATIONAL_PRODUCTION_UUID = '2';
		const NATIONAL_THEATRE_VENUE_UUID = '3';
		const MACBETH_ALMEIDA_PRODUCTION_UUID = '4';
		const ALMEIDA_THEATRE_VENUE_UUID = '5';
		const HAMLET_WYNDHAMS_PRODUCTION_UUID = '6';
		const WYNDHAMS_THEATRE_VENUE_UUID = '7';
		const HAMLET_ALMEIDA_PRODUCTION_UUID = '8';
