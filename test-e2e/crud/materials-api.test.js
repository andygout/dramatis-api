...
describe('CRUD (Create, Read, Update, Delete): Materials API', () => {
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const MATERIAL_UUID = '15';
		const JOHN_GABRIEL_BORKMAN_ORIGINAL_VERSION_MATERIAL_UUID = '16';
		const HENRIK_IBSEN_PERSON_UUID = '17';
		const IBSEN_THEATRE_COMPANY_UUID = '18';
		const DAVID_ELDRIDGE_PERSON_UUID = '19';
		const JOHN_GABRIEL_BORKMAN_SOURCE_MATERIAL_MATERIAL_UUID = '20';
		const JOHN_GABRIEL_BORKMAN_SUB_MATERIAL_1_MATERIAL_UUID = '21';
		const JOHN_GABRIEL_BORKMAN_SUB_MATERIAL_2_MATERIAL_UUID = '22';
		const JOHN_GABRIEL_BORKMAN_SUB_MATERIAL_3_MATERIAL_UUID = '23';
