...
describe('CRUD (Create, Read, Update, Delete): Award ceremonies API', () => {
	...
	describe('CRUD with minimum range of attributes assigned values', () => {
		...
		const AWARD_CEREMONY_UUID = '2020_AWARD_CEREMONY_2_UUID';
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const GARPLY_WYNDHAMS_PRODUCTION_UUID = 'GARPLY_PRODUCTION_2_UUID';
		...
		const AWARD_CEREMONY_UUID = '2008_AWARD_CEREMONY_2_UUID';
		const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = 'LAURENCE_OLIVIER_AWARDS_AWARD_1_UUID';
		const STEVE_C_KENNEDY_PERSON_UUID = 'STEVE_C_KENNEDY_PERSON_1_UUID';
		const HAIRSPRAY_MATERIAL_UUID = 'HAIRSPRAY_MATERIAL_1_UUID';
		const SOUNDWAVES_LTD_COMPANY_UUID = 'SOUNDWAVES_LTD_COMPANY_1_UUID';
		const GARPLY_MATERIAL_UUID = 'GARPLY_MATERIAL_1_UUID';
		const PAUL_ARDITTI_PERSON_UUID = 'PAUL_ARDITTI_PERSON_1_UUID';
		const JOCELYN_POOK_PERSON_UUID = 'JOCELYN_POOK_PERSON_1_UUID';
		const SAINT_JOAN_MATERIAL_UUID = 'SAINT_JOAN_MATERIAL_1_UUID';
		const AUTOGRAPH_COMPANY_UUID = 'AUTOGRAPH_COMPANY_1_UUID';
		const TERRY_JARDINE_PERSON_UUID = 'TERRY_JARDINE_PERSON_1_UUID';
		const NICK_LIDSTER_PERSON_UUID ='NICK_LIDSTER_PERSON_1_UUID';
		const PARADE_MATERIAL_UUID = 'PARADE_MATERIAL_1_UUID';
		const AUDIO_CREATIVE_LTD_COMPANY_UUID = 'AUDIO_CREATIVE_LTD_COMPANY_1_UUID';
		const SIMON_BAKER_PERSON_UUID ='SIMON_BAKER_PERSON_1_UUID';
		const ROB_ASHFORD_PERSON_UUID = 'ROB_ASHFORD_PERSON_1_UUID';
		const MARIANNE_ELLIOTT_PERSON_UUID = 'MARIANNE_ELLIOTT_PERSON_1_UUID';
		const TOM_MORRIS_PERSON_UUID = 'TOM_MORRIS_PERSON_1_UUID';
		const RUPERT_GOOLD_PERSON_UUID = 'RUPERT_GOOLD_PERSON_1_UUID';
		const A_DISAPPEARING_NUMBER_MATERIAL_UUID = 'A_DISAPPEARING_NUMBER_MATERIAL_1_UUID';
		const THE_REPORTER_MATERIAL_UUID = 'THE_REPORTER_MATERIAL_1_UUID';
		const VERNON_GOD_LITTLE_MATERIAL_UUID = 'VERNON_GOD_LITTLE_MATERIAL_1_UUID';
		...
		const PIAF_VAUDEVILLE_PRODUCTION_UUID = 'PIAF_PRODUCTION_2_UUID';
		...
		const WALDO_NOËL_COWARD_PRODUCTION_UUID = 'WALDO_PRODUCTION_2_UUID';
		...
		const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = 'EVENING_STANDARD_THEATRE_AWARDS_AWARD_2_UUID';
		const PAULE_CONSTABLE_PERSON_UUID = 'PAULE_CONSTABLE_PERSON_1_UUID';
		const THE_CHALK_GARDEN_MATERIAL_UUID = 'THE_CHALK_GARDEN_MATERIAL_1_UUID';
		const ILLUMINATIONS_LTD_COMPANY_UUID = 'ILLUMINATIONS_LTD_COMPANY_1_UUID';
		const PIAF_MATERIAL_UUID = 'PIAF_MATERIAL_1_UUID';
		const NEIL_AUSTIN_PERSON_UUID = 'NEIL_AUSTIN_PERSON_1_UUID';
		const MARK_HENDERSON_PERSON_UUID = 'MARK_HENDERSON_PERSON_1_UUID';
		const IVANOV_MATERIAL_UUID = 'IVANOV_MATERIAL_1_UUID';
		const LIMELIGHT_LTD_COMPANY_UUID = 'LIMELIGHT_LTD_COMPANY_1_UUID';
		const KEVIN_ADAMS_PERSON_UUID = 'KEVIN_ADAMS_PERSON_1_UUID';
		const JON_CLARK_PERSON_UUID = 'JON_CLARK_PERSON_1_UUID';
		const WALDO_MATERIAL_UUID = 'WALDO_MATERIAL_1_UUID';
		const STAGE_SUN_LTD_COMPANY_UUID = 'STAGE_SUN_LTD_COMPANY_1_UUID';
		const HOWARD_HARRISON_PERSON_UUID = 'HOWARD_HARRISON_PERSON_1_UUID';
		const RAFAEL_AMARGO_PERSON_UUID = 'RAFAEL_AMARGO_PERSON_1_UUID';
		const STEVEN_HOGGETT_PERSON_UUID = 'STEVEN_HOGGETT_PERSON_1_UUID';
		const LYNNE_PAGE_PERSON_UUID = 'LYNNE_PAGE_PERSON_1_UUID';
		const KATE_PRINCE_PERSON_UUID = 'KATE_PRINCE_PERSON_1_UUID';
		const ENGLAND_PEOPLE_VERY_NICE_MATERIAL_UUID = 'ENGLAND_PEOPLE_VERY_NICE_MATERIAL_1_UUID';
		const JERUSALEM_MATERIAL_UUID = 'JERUSALEM_MATERIAL_1_UUID';
		const OUR_CLASS_MATERIAL_UUID = 'OUR_CLASS_MATERIAL_1_UUID';
	...
	describe('GET list endpoint', () => {
		...
		const LAURENCE_OLIVIER_AWARDS_2019_AWARD_CEREMONY_UUID = '2019_AWARD_CEREMONY_2_UUID';
		const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = 'LAURENCE_OLIVIER_AWARDS_AWARD_UUID';
		const LAURENCE_OLIVIER_AWARDS_2020_AWARD_CEREMONY_UUID = '2020_AWARD_CEREMONY_2_UUID';
		const LAURENCE_OLIVIER_AWARDS_2018_AWARD_CEREMONY_UUID = '2018_AWARD_CEREMONY_2_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_2019_AWARD_CEREMONY_UUID = '2019_AWARD_CEREMONY_4_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = 'EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_2020_AWARD_CEREMONY_UUID = '2020_AWARD_CEREMONY_4_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_2018_AWARD_CEREMONY_UUID = '2018_AWARD_CEREMONY_4_UUID';
