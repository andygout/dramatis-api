...
describe('CRUD (Create, Read, Update, Delete): Award ceremonies API', () => {
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const GARPLY_LYTTELTON_PRODUCTION_UUID = '4';
		const LYTTELTON_THEATRE_VENUE_UUID = '6';
		const GARPLY_WYNDHAMS_PRODUCTION_UUID = '8';
		const WYNDHAMS_THEATRE_VENUE_UUID = '10';
		const SAINT_JOAN_OLIVIER_PRODUCTION_UUID = '12';
		const OLIVIER_THEATRE_VENUE_UUID = '14';
		const PARADE_DONMAR_PRODUCTION_UUID = '16';
		const DONMAR_WAREHOUSE_VENUE_UUID = '18';
		const GRAULT_ALMEIDA_PRODUCTION_UUID = '20';
		const ALMEIDA_THEATRE_VENUE_UUID = '22';
		const AWARD_CEREMONY_UUID = '46';
		const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '47';
		const STEVE_C_KENNEDY_PERSON_UUID = '48';
		const HAIRSPRAY_MATERIAL_UUID = '49';
		const SOUNDWAVES_LTD_COMPANY_UUID = '50';
		const GARPLY_MATERIAL_UUID = '51';
		const PAUL_ARDITTI_PERSON_UUID = '52';
		const JOCELYN_POOK_PERSON_UUID = '53';
		const SAINT_JOAN_MATERIAL_UUID = '54';
		const AUTOGRAPH_COMPANY_UUID = '55';
		const TERRY_JARDINE_PERSON_UUID = '56';
		const NICK_LIDSTER_PERSON_UUID ='57';
		const PARADE_MATERIAL_UUID = '58';
		const AUDIO_CREATIVE_LTD_COMPANY_UUID = '59';
		const SIMON_BAKER_PERSON_UUID ='60';
		const ROB_ASHFORD_PERSON_UUID = '61';
		const MARIANNE_ELLIOTT_PERSON_UUID = '62';
		const TOM_MORRIS_PERSON_UUID = '63';
		const RUPERT_GOOLD_PERSON_UUID = '64';
		const A_DISAPPEARING_NUMBER_MATERIAL_UUID = '65';
		const THE_REPORTER_MATERIAL_UUID = '66';
		const VERNON_GOD_LITTLE_MATERIAL_UUID = '67';
		const THE_CHALK_GARDEN_DONMAR_PRODUCTION_UUID = '110';
		const PIAF_DONMAR_PRODUCTION_UUID = '114';
		const PIAF_VAUDEVILLE_PRODUCTION_UUID = '118';
		const VAUDEVILLE_THEATRE_VENUE_UUID = '120';
		const IVANOV_WYNDHAMS_PRODUCTION_UUID = '122';
		const WALDO_DORFMAN_PRODUCTION_UUID = '126';
		const DORFMAN_THEATRE_VENUE_UUID = '128';
		const WALDO_NOËL_COWARD_PRODUCTION_UUID = '130';
		const NOËL_COWARD_THEATRE_VENUE_UUID = '132';
		const FRED_OLD_VIC_PRODUCTION_UUID = '134';
		const OLD_VIC_THEATRE_VENUE_UUID = '136';
		const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '159';
		const PAULE_CONSTABLE_PERSON_UUID = '160';
		const THE_CHALK_GARDEN_MATERIAL_UUID = '161';
		const ILLUMINATIONS_LTD_COMPANY_UUID = '162';
		const PIAF_MATERIAL_UUID = '163';
		const NEIL_AUSTIN_PERSON_UUID = '164';
		const MARK_HENDERSON_PERSON_UUID = '165';
		const IVANOV_MATERIAL_UUID = '166';
		const LIMELIGHT_LTD_COMPANY_UUID = '167';
		const KEVIN_ADAMS_PERSON_UUID = '168';
		const JON_CLARK_PERSON_UUID = '169';
		const WALDO_MATERIAL_UUID = '170';
		const STAGE_SUN_LTD_COMPANY_UUID = '171';
		const HOWARD_HARRISON_PERSON_UUID = '172';
		const RAFAEL_AMARGO_PERSON_UUID = '173';
		const STEVEN_HOGGETT_PERSON_UUID = '174';
		const LYNNE_PAGE_PERSON_UUID = '175';
		const KATE_PRINCE_PERSON_UUID = '176';
		const ENGLAND_PEOPLE_VERY_NICE_MATERIAL_UUID = '177';
		const JERUSALEM_MATERIAL_UUID = '178';
		const OUR_CLASS_MATERIAL_UUID = '179';
