...
describe('CRUD (Create, Read, Update, Delete): Award ceremonies API', () => {
	...
	describe('GET list endpoint', () => {
		...
		const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '2019_2_AWARD_CEREMONY_UUID';
		...
		const LAURENCE_OLIVIER_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '2018_2_AWARD_CEREMONY_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_NINETEEN_AWARD_CEREMONY_UUID = '2019_4_AWARD_CEREMONY_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = 'EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_TWENTY_AWARD_CEREMONY_UUID = '2020_4_AWARD_CEREMONY_UUID';
		const EVENING_STANDARD_THEATRE_AWARDS_TWO_THOUSAND_AND_EIGHTEEN_AWARD_CEREMONY_UUID = '2018_4_AWARD_CEREMONY_UUID';
