...
describe('CRUD (Create, Read, Update, Delete): Award ceremonies API', () => {
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const SHAFTESBURY_THEATRE_VENUE_UUID = '1';
		const GARPLY_LYTTELTON_PRODUCTION_UUID = '2';
		const LYTTELTON_THEATRE_VENUE_UUID = '3';
		const GARPLY_WYNDHAMS_PRODUCTION_UUID = '4';
		const WYNDHAMS_THEATRE_VENUE_UUID = '5';
		const SAINT_JOAN_OLIVIER_PRODUCTION_UUID = '6';
		const OLIVIER_THEATRE_VENUE_UUID = '7';
		const PARADE_DONMAR_PRODUCTION_UUID = '8';
		const DONMAR_WAREHOUSE_VENUE_UUID = '9';
		const GRAULT_ALMEIDA_PRODUCTION_UUID = '10';
		const ALMEIDA_THEATRE_VENUE_UUID = '11';
		const AWARD_CEREMONY_UUID = '34';
		const LAURENCE_OLIVIER_AWARDS_AWARD_UUID = '35';
		const STEVE_C_KENNEDY_PERSON_UUID = '36';
		const HAIRSPRAY_MATERIAL_UUID = '37';
		const SOUNDWAVES_LTD_COMPANY_UUID = '38';
		const GARPLY_MATERIAL_UUID = '39';
		const PAUL_ARDITTI_PERSON_UUID = '40';
		const JOCELYN_POOK_PERSON_UUID = '41';
		const SAINT_JOAN_MATERIAL_UUID = '42';
		const AUTOGRAPH_COMPANY_UUID = '43';
		const TERRY_JARDINE_PERSON_UUID = '44';
		const NICK_LIDSTER_PERSON_UUID ='45';
		const PARADE_MATERIAL_UUID = '46';
		const AUDIO_CREATIVE_LTD_COMPANY_UUID = '47';
		const SIMON_BAKER_PERSON_UUID ='48';
		const ROB_ASHFORD_PERSON_UUID = '49';
		const MARIANNE_ELLIOTT_PERSON_UUID = '50';
		const TOM_MORRIS_PERSON_UUID = '51';
		const RUPERT_GOOLD_PERSON_UUID = '52';
		const A_DISAPPEARING_NUMBER_MATERIAL_UUID = '53';
		const THE_REPORTER_MATERIAL_UUID = '54';
		const VERNON_GOD_LITTLE_MATERIAL_UUID = '55';
		const THE_CHALK_GARDEN_DONMAR_PRODUCTION_UUID = '98';
		const PIAF_DONMAR_PRODUCTION_UUID = '100';
		const PIAF_VAUDEVILLE_PRODUCTION_UUID = '102';
		const VAUDEVILLE_THEATRE_VENUE_UUID = '103';
		const IVANOV_WYNDHAMS_PRODUCTION_UUID = '104';
		const WALDO_DORFMAN_PRODUCTION_UUID = '106';
		const DORFMAN_THEATRE_VENUE_UUID = '107';
		const WALDO_NOËL_COWARD_PRODUCTION_UUID = '108';
		const NOËL_COWARD_THEATRE_VENUE_UUID = '109';
		const FRED_OLD_VIC_PRODUCTION_UUID = '110';
		const OLD_VIC_THEATRE_VENUE_UUID = '111';
		const EVENING_STANDARD_THEATRE_AWARDS_AWARD_UUID = '133';
		const PAULE_CONSTABLE_PERSON_UUID = '134';
		const THE_CHALK_GARDEN_MATERIAL_UUID = '135';
		const ILLUMINATIONS_LTD_COMPANY_UUID = '136';
		const PIAF_MATERIAL_UUID = '137';
		const NEIL_AUSTIN_PERSON_UUID = '138';
		const MARK_HENDERSON_PERSON_UUID = '139';
		const IVANOV_MATERIAL_UUID = '140';
		const LIMELIGHT_LTD_COMPANY_UUID = '141';
		const KEVIN_ADAMS_PERSON_UUID = '142';
		const JON_CLARK_PERSON_UUID = '143';
		const WALDO_MATERIAL_UUID = '144';
		const STAGE_SUN_LTD_COMPANY_UUID = '145';
		const HOWARD_HARRISON_PERSON_UUID = '146';
		const RAFAEL_AMARGO_PERSON_UUID = '147';
		const STEVEN_HOGGETT_PERSON_UUID = '148';
		const LYNNE_PAGE_PERSON_UUID = '149';
		const KATE_PRINCE_PERSON_UUID = '150';
		const ENGLAND_PEOPLE_VERY_NICE_MATERIAL_UUID = '151';
		const JERUSALEM_MATERIAL_UUID = '152';
		const OUR_CLASS_MATERIAL_UUID = '153';
