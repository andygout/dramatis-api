...
describe('CRUD (Create, Read, Update, Delete): Festivals API', () => {
	...
	describe('CRUD', () => {
		...
		const FESTIVAL_UUID = 'THE_COMPLETE_WORKS_FESTIVAL_UUID';
	...
	describe('CRUD with full range of attributes assigned values', () => {
		...
		const FESTIVAL_UUID = '2008_FESTIVAL_1_UUID';
		const EDINBURGH_INTERNATIONAL_FESTIVAL_FESTIVAL_SERIES_UUID = 'EDINBURGH_INTERNATIONAL_FESTIVAL_FESTIVAL_SERIES_1_UUID';
		const CONNECTIONS_FESTIVAL_SERIES_UUID = 'CONNECTIONS_FESTIVAL_SERIES_1_UUID';
