...
describe('Character with variant names', () => {
	...
	const DAVID_RINTOUL_PERSON_UUID = '10';
	const HAMLET_NOVELLO_PRODUCTION_UUID = '13';
	const NOVELLO_THEATRE_UUID = '14';
	const PATRICK_STEWART_PERSON_UUID = '18';
	const HAMLET_WYNDHAMS_PRODUCTION_UUID = '21';
	const WYNDHAMS_THEATRE_UUID = '22';
