...
describe('Character in multiple playtexts', () => {
	...
	const HENRY_IV_PART_2_GLOBE_PRODUCTION_UUID = '11';
	const GLOBE_THEATRE_UUID = '12';
	const ROGER_ALLAM_PERSON_UUID = '14';
	const MERRY_WIVES_OF_WINDSOR_SWAN_PRODUCTION_UUID = '16';
	const SWAN_THEATRE_UUID = '17';
	const RICHARD_CORDERY_PERSON_UUID = '19';
